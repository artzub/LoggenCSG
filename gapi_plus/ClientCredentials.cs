...
namespace LoggenCSG {
	...
	internal static class ClientCredentials {
		...
		/// </summary>
		public static readonly string ClientID = "903812459419.apps.googleusercontent.com";

		/// <summary>
		/// The OAuth2.0 Client secret of your project.
		/// </summary>
		public static readonly string ClientSecret = "kUIVcJoprErNSFOZe8HXzeg-";

		/// <summary>
		/// Your Api/Developer key.
		/// </summary>
		public static readonly string ApiKey = "AIzaSyCqVDlXyRu1I1HhUvvPjc_q2038gFSnb6U";
