...
namespace Google.Apis.Books.v1 {
    ...
    public partial class BooksService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"books:v1\",\"name\":\"books\",\"version\":\"v1\"" +
            ...
            "n\":\"An ISO 4217, three-letter currency code. (In LITE projection.)\"}}},\"onSaleDa" +
            "te\":{\"type\":\"string\",\"description\":\"The date on which this book is available for" +
            " sale.\",\"format\":\"uint64\"},\"retailPrice\":{\"type\":\"object\",\"description\":\"The act" +
            "ual selling price of the book. This is the same as the suggested retail or list " +
            ...
            "string\",\"description\":\"An ISO 4217, three-letter currency code. (In LITE project" +
            "ion.)\"}}},\"saleability\":{\"type\":\"string\",\"description\":\"Whether or not this book" +
            " is available for sale or offered for free in the Google eBookstore for the coun" +
            "try listed above. Possible values are FOR_SALE, FREE, NOT_FOR_SALE, or FOR_PREOR" +
            "DER.\"}}},\"selfLink\":{\"type\":\"string\",\"description\":\"URL to this resource. (In LI" +
            ...
            "rchased this book)\",\"properties\":{\"isPreordered\":{\"type\":\"boolean\",\"description\"" +
            ":\"Whether or not this volume was pre-ordered by the authenticated user making th" +
            "e request. (In LITE projection.)\"},\"isPurchased\":{\"type\":\"boolean\",\"description\"" +
            ":\"Whether or not this volume was purchased by the authenticated user making the " +
            "request. (In LITE projection.)\"},\"readingPosition\":{\"$ref\":\"ReadingPosition\",\"de" +
            "scription\":\"The user\'s current reading position in the volume, if one is availab" +
            "le. (In LITE projection.)\"},\"review\":{\"$ref\":\"Review\",\"description\":\"This user\'s" +
            " review of this volume, if one exists.\"},\"updated\":{\"type\":\"string\",\"description" +
            "\":\"Timestamp when this volume was last modified by a user action, such as a read" +
            "ing position update, volume purchase or writing a review. (RFC 3339 UTC date-tim" +
            "e format).\",\"format\":\"date-time\"}}},\"volumeInfo\":{\"type\":\"object\",\"description\":" +
            "\"General volume information.\",\"properties\":{\"authors\":{\"type\":\"array\",\"descripti" +
            "on\":\"The names of the authors and/or editors for this volume. (In LITE projectio" +
            "n)\",\"items\":{\"type\":\"string\"}},\"averageRating\":{\"type\":\"number\",\"description\":\"T" +
            "he mean review rating for this volume. (min = 1.0, max = 5.0)\",\"format\":\"double\"" +
            "},\"categories\":{\"type\":\"array\",\"description\":\"A list of subject categories, such" +
            " as \\\"Fiction\\\", \\\"Suspense\\\", etc.\",\"items\":{\"type\":\"string\"}},\"contentVersion\"" +
            ":{\"type\":\"string\",\"description\":\"An identifier for the version of the volume con" +
            "tent (text & images). (In LITE projection)\"},\"description\":{\"type\":\"string\",\"des" +
            "cription\":\"A synopsis of the volume. The text of the description is formatted in" +
            " HTML and includes simple formatting elements, such as b, i, and br tags. (In LI" +
            "TE projection.)\"},\"dimensions\":{\"type\":\"object\",\"description\":\"Physical dimensio" +
            "ns of this volume.\",\"properties\":{\"height\":{\"type\":\"string\",\"description\":\"Heigh" +
            "t or length of this volume (in cm).\"},\"thickness\":{\"type\":\"string\",\"description\"" +
            ":\"Thickness of this volume (in cm).\"},\"width\":{\"type\":\"string\",\"description\":\"Wi" +
            "dth of this volume (in cm).\"}}},\"imageLinks\":{\"type\":\"object\",\"description\":\"A l" +
            "ist of image links for all the sizes that are available. (In LITE projection.)\"," +
            "\"properties\":{\"extraLarge\":{\"type\":\"string\",\"description\":\"Image link for extra " +
            "large size (width of ~1280 pixels). (In LITE projection)\"},\"large\":{\"type\":\"stri" +
            "ng\",\"description\":\"Image link for large size (width of ~800 pixels). (In LITE pr" +
            "ojection)\"},\"medium\":{\"type\":\"string\",\"description\":\"Image link for medium size " +
            "(width of ~575 pixels). (In LITE projection)\"},\"small\":{\"type\":\"string\",\"descrip" +
            "tion\":\"Image link for small size (width of ~300 pixels). (In LITE projection)\"}," +
            "\"smallThumbnail\":{\"type\":\"string\",\"description\":\"Image link for small thumbnail " +
            "size (width of ~80 pixels). (In LITE projection)\"},\"thumbnail\":{\"type\":\"string\"," +
            "\"description\":\"Image link for thumbnail size (width of ~128 pixels). (In LITE pr" +
            "ojection)\"}}},\"industryIdentifiers\":{\"type\":\"array\",\"description\":\"Industry stan" +
            "dard identifiers for this volume.\",\"items\":{\"type\":\"object\",\"properties\":{\"ident" +
            "ifier\":{\"type\":\"string\",\"description\":\"Industry specific volume identifier.\"},\"t" +
            "ype\":{\"type\":\"string\",\"description\":\"Identifier type. Possible values are ISBN_1" +
            "0, ISBN_13, ISSN and OTHER.\"}}}},\"infoLink\":{\"type\":\"string\",\"description\":\"URL " +
            "to view information about this volume on the Google Books site. (In LITE project" +
            "ion)\"},\"language\":{\"type\":\"string\",\"description\":\"Best language for this volume " +
            "(based on content). It is the two-letter ISO 639-1 code such as \'fr\', \'en\', etc." +
            "\"},\"mainCategory\":{\"type\":\"string\",\"description\":\"The main category to which thi" +
            "s volume belongs. It will be the category from the categories list returned belo" +
            "w that has the highest weight.\"},\"pageCount\":{\"type\":\"integer\",\"description\":\"To" +
            "tal number of pages.\",\"format\":\"int32\"},\"previewLink\":{\"type\":\"string\",\"descript" +
            "ion\":\"URL to preview this volume on the Google Books site.\"},\"printType\":{\"type\"" +
            ":\"string\",\"description\":\"Type of publication of this volume. Possible values are" +
            " BOOK or MAGAZINE.\"},\"publishedDate\":{\"type\":\"string\",\"description\":\"Date of pub" +
            "lication. (In LITE projection.)\"},\"publisher\":{\"type\":\"string\",\"description\":\"Pu" +
            "blisher of this volume. (In LITE projection.)\"},\"ratingsCount\":{\"type\":\"integer\"" +
            ",\"description\":\"The number of review ratings for this volume.\",\"format\":\"int32\"}" +
            ",\"subtitle\":{\"type\":\"string\",\"description\":\"Volume subtitle. (In LITE projection" +
            ".)\"},\"title\":{\"type\":\"string\",\"description\":\"Volume title. (In LITE projection.)" +
            "\"}}}}},\"Volumes\":{\"id\":\"Volumes\",\"type\":\"object\",\"properties\":{\"items\":{\"type\":\"" +
            "array\",\"description\":\"A list of volumes.\",\"items\":{\"$ref\":\"Volume\"}},\"kind\":{\"ty" +
            "pe\":\"string\",\"description\":\"Resource type.\",\"default\":\"books#volumes\"},\"totalIte" +
            "ms\":{\"type\":\"integer\",\"description\":\"Total number of volumes found. This might b" +
            "e greater than the number of volumes returned in this response if results have b" +
            "een paginated.\",\"format\":\"int32\"}}}},\"resources\":{\"bookshelves\":{\"methods\":{\"get" +
            "\":{\"id\":\"books.bookshelves.get\",\"path\":\"users/{userId}/bookshelves/{shelf}\",\"htt" +
            "pMethod\":\"GET\",\"description\":\"Retrieves a specific bookshelf for the specified u" +
            "ser.\",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to" +
            " override the IP-based location.\",\"location\":\"query\"},\"shelf\":{\"type\":\"string\",\"" +
            ...
            "s request.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"description\":\"Id of u" +
            "ser for whom to retrieve bookshelves.\",\"required\":true,\"location\":\"path\"}},\"para" +
            "meterOrder\":[\"userId\",\"shelf\"],\"response\":{\"$ref\":\"Bookshelf\"},\"scopes\":[\"https:" +
            "//www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.bookshelves.list\",\"path\":" +
            "\"users/{userId}/bookshelves\",\"httpMethod\":\"GET\",\"description\":\"Retrieves a list " +
            "of public bookshelves for the specified user.\",\"parameters\":{\"country\":{\"type\":\"" +
            ...
            "riginator of this request.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descr" +
            "iption\":\"Id of user for whom to retrieve bookshelves.\",\"required\":true,\"location" +
            "\":\"path\"}},\"parameterOrder\":[\"userId\"],\"response\":{\"$ref\":\"Bookshelves\"},\"scopes" +
            "\":[\"https://www.googleapis.com/auth/books\"]}},\"resources\":{\"volumes\":{\"methods\":" +
            "{\"list\":{\"id\":\"books.bookshelves.volumes.list\",\"path\":\"users/{userId}/bookshelve" +
            "s/{shelf}/volumes\",\"httpMethod\":\"GET\",\"description\":\"Retrieves volumes in a spec" +
            "ific bookshelf for the specified user.\",\"parameters\":{\"country\":{\"type\":\"string\"" +
            ...
            "to return\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"},\"shelf\":{\"type\":\"" +
            "string\",\"description\":\"Id of bookshelf to retrieve volumes.\",\"required\":true,\"lo" +
            "cation\":\"path\"},\"showPreorders\":{\"type\":\"boolean\",\"description\":\"Set to true to " +
            ...
            "t element to return (starts at 0)\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"q" +
            "uery\"},\"userId\":{\"type\":\"string\",\"description\":\"Id of user for whom to retrieve " +
            "bookshelf volumes.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userI" +
            "d\",\"shelf\"],\"response\":{\"$ref\":\"Volumes\"},\"scopes\":[\"https://www.googleapis.com/" +
            "auth/books\"]}}}}},\"mylibrary\":{\"resources\":{\"bookshelves\":{\"methods\":{\"addVolume" +
            "\":{\"id\":\"books.mylibrary.bookshelves.addVolume\",\"path\":\"mylibrary/bookshelves/{s" +
            "helf}/addVolume\",\"httpMethod\":\"POST\",\"description\":\"Adds a volume to a bookshelf" +
            ...
            "cription\":\"Id of bookshelf to which to add a volume.\",\"required\":true,\"location\"" +
            ":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the origina" +
            "tor of this request.\",\"location\":\"query\"},\"volumeId\":{\"type\":\"string\",\"descripti" +
            "on\":\"Id of volume to add.\",\"required\":true,\"location\":\"query\"}},\"parameterOrder\"" +
            ":[\"shelf\",\"volumeId\"],\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"clear" +
            "Volumes\":{\"id\":\"books.mylibrary.bookshelves.clearVolumes\",\"path\":\"mylibrary/book" +
            "shelves/{shelf}/clearVolumes\",\"httpMethod\":\"POST\",\"description\":\"Clears all volu" +
            "mes from a bookshelf.\",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"I" +
            "SO-3166-1 code to override the IP-based location.\",\"location\":\"query\"},\"shelf\":{" +
            "\"type\":\"string\",\"description\":\"Id of bookshelf from which to remove a volume.\",\"" +
            "required\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"Strin" +
            "g to identify the originator of this request.\",\"location\":\"query\"}},\"parameterOr" +
            "der\":[\"shelf\"],\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"get\":{\"id\":\"" +
            "books.mylibrary.bookshelves.get\",\"path\":\"mylibrary/bookshelves/{shelf}\",\"httpMet" +
            "hod\":\"GET\",\"description\":\"Retrieves a specific bookshelf belonging to the authen" +
            "ticated user.\",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166-" +
            "1 code to override the IP-based location.\",\"location\":\"query\"},\"shelf\":{\"type\":\"" +
            "string\",\"description\":\"Id of bookshelf to retrieve.\",\"required\":true,\"location\":" +
            "\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the originat" +
            "or of this request.\",\"location\":\"query\"}},\"parameterOrder\":[\"shelf\"],\"response\":" +
            "{\"$ref\":\"Bookshelf\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":" +
            "{\"id\":\"books.mylibrary.bookshelves.list\",\"path\":\"mylibrary/bookshelves\",\"httpMet" +
            "hod\":\"GET\",\"description\":\"Retrieves a list of bookshelves belonging to the authe" +
            "nticated user.\",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166" +
            "-1 code to override the IP-based location.\",\"location\":\"query\"},\"source\":{\"type\"" +
            ":\"string\",\"description\":\"String to identify the originator of this request.\",\"lo" +
            "cation\":\"query\"}},\"response\":{\"$ref\":\"Bookshelves\"},\"scopes\":[\"https://www.googl" +
            "eapis.com/auth/books\"]},\"removeVolume\":{\"id\":\"books.mylibrary.bookshelves.remove" +
            "Volume\",\"path\":\"mylibrary/bookshelves/{shelf}/removeVolume\",\"httpMethod\":\"POST\"," +
            "\"description\":\"Removes a volume from a bookshelf.\",\"parameters\":{\"country\":{\"typ" +
            "e\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based location.\",\"" +
            "location\":\"query\"},\"shelf\":{\"type\":\"string\",\"description\":\"Id of bookshelf from " +
            ...
            "r name retrieve volumes for.\",\"location\":\"path\"},\"showPreorders\":{\"type\":\"boolea" +
            "n\",\"description\":\"Set to true to show pre-ordered books. Defaults to false.\",\"lo" +
            "cation\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the" +
            " originator of this request.\",\"location\":\"query\"},\"startIndex\":{\"type\":\"integer\"" +
            ",\"description\":\"Index of the first element to return (starts at 0)\",\"format\":\"ui" +
            "nt32\",\"minimum\":\"0\",\"location\":\"query\"}},\"parameterOrder\":[\"shelf\"],\"response\":{" +
            "\"$ref\":\"Volumes\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}}}},\"vol" +
            "umes\":{\"methods\":{\"get\":{\"id\":\"books.volumes.get\",\"path\":\"volumes/{volumeId}\",\"h" +
            "ttpMethod\":\"GET\",\"description\":\"Gets volume information for a single volume.\",\"p" +
            "arameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to overrid" +
            "e the IP-based location.\",\"location\":\"query\"},\"partner\":{\"type\":\"string\",\"descri" +
            "ption\":\"Identifier of partner for whom to brand results.\",\"location\":\"query\"},\"p" +
            ...
            "cription\":\"Id of volume to retrieve.\",\"required\":true,\"location\":\"path\"}},\"param" +
            "eterOrder\":[\"volumeId\"],\"response\":{\"$ref\":\"Volume\"},\"scopes\":[\"https://www.goog" +
            "leapis.com/auth/books\"]},\"list\":{\"id\":\"books.volumes.list\",\"path\":\"volumes\",\"htt" +
            "pMethod\":\"GET\",\"description\":\"Performs a book search.\",\"parameters\":{\"country\":{" +
            "\"type\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based location" +
            ".\",\"location\":\"query\"},\"download\":{\"type\":\"string\",\"description\":\"Restrict to vo" +
            "lumes by download availability.\",\"enum\":[\"epub\"],\"enumDescriptions\":[\"All volume" +
            "s with epub.\"],\"location\":\"query\"},\"filter\":{\"type\":\"string\",\"description\":\"Filt" +
            "er search results.\",\"enum\":[\"ebooks\",\"free-ebooks\",\"full\",\"paid-ebooks\",\"partial" +
            "\"],\"enumDescriptions\":[\"All Google eBooks.\",\"Google eBook with full volume text " +
            "viewability.\",\"Public can view entire volume text.\",\"Google eBook with a price.\"" +
            ",\"Public able to see parts of text.\"],\"location\":\"query\"},\"langRestrict\":{\"type\"" +
            ":\"string\",\"description\":\"Restrict results to books with this language code.\",\"lo" +
            "cation\":\"query\"},\"libraryRestrict\":{\"type\":\"string\",\"description\":\"Restrict sear" +
            "ch to this user\'s library.\",\"enum\":[\"my-library\",\"no-restrict\"],\"enumDescription" +
            "s\":[\"Restrict to the user\'s library, any shelf.\",\"Do not restrict based on user\'" +
            "s library.\"],\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"M" +
            "aximum number of results to return.\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"" +
            "40\",\"location\":\"query\"},\"orderBy\":{\"type\":\"string\",\"description\":\"Sort search re" +
            "sults.\",\"enum\":[\"newest\",\"relevance\"],\"enumDescriptions\":[\"Most recently publish" +
            "ed.\",\"Relevance to search terms.\"],\"location\":\"query\"},\"partner\":{\"type\":\"string" +
            "\",\"description\":\"Identifier of partner for whom to restrict and brand results.\"," +
            "\"location\":\"query\"},\"printType\":{\"type\":\"string\",\"description\":\"Restrict to book" +
            "s or magazines.\",\"enum\":[\"all\",\"books\",\"magazines\"],\"enumDescriptions\":[\"All vol" +
            "ume content types.\",\"Just books.\",\"Just magazines.\"],\"location\":\"query\"},\"projec" +
            "tion\":{\"type\":\"string\",\"description\":\"Restrict information returned to a set of " +
            "selected fields.\",\"enum\":[\"full\",\"lite\"],\"enumDescriptions\":[\"Includes all volum" +
            "e data.\",\"Includes a subset of fields in volumeInfo and accessInfo.\"],\"location\"" +
            ":\"query\"},\"q\":{\"type\":\"string\",\"description\":\"Full-text search query string.\",\"r" +
            "equired\":true,\"location\":\"query\"},\"showPreorders\":{\"type\":\"boolean\",\"description" +
            "\":\"Set to true to show books available for preorder. Defaults to false.\",\"locati" +
            "on\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the ori" +
            "ginator of this request.\",\"location\":\"query\"},\"startIndex\":{\"type\":\"integer\",\"de" +
            "scription\":\"Index of the first result to return (starts at 0)\",\"format\":\"uint32\"" +
            ",\"minimum\":\"0\",\"location\":\"query\"}},\"parameterOrder\":[\"q\"],\"response\":{\"$ref\":\"V" +
