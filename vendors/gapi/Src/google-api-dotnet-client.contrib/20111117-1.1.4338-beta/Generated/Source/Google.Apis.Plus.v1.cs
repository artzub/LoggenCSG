...
namespace Google.Apis.Plus.v1 {
    ...
    public partial class PlusService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"plus:v1\",\"name\":\"plus\",\"version\":\"v1\",\"" +
            ...
            "nickname\":{\"type\":\"string\",\"description\":\"The nickname of this person.\"},\"object" +
            "Type\":{\"type\":\"string\",\"description\":\"Type of person within Google+. Possible va" +
            "lues are:  \\n- \\\"person\\\" - represents an actual person. \\n- \\\"page\\\" - represen" +
            "ts a page.\"},\"organizations\":{\"type\":\"array\",\"description\":\"A list of current or" +
            " past organizations with which this person is associated.\",\"items\":{\"type\":\"obje" +
            "ct\",\"properties\":{\"department\":{\"type\":\"string\",\"description\":\"The department wi" +
            "thin the organization.\"},\"description\":{\"type\":\"string\",\"description\":\"A short d" +
            "escription of the person\'s role in this organization.\"},\"endDate\":{\"type\":\"strin" +
            "g\",\"description\":\"The date the person left this organization.\"},\"location\":{\"typ" +
            "e\":\"string\",\"description\":\"The location of this organization.\"},\"name\":{\"type\":\"" +
            "string\",\"description\":\"The name of the organization.\"},\"primary\":{\"type\":\"boolea" +
            "n\",\"description\":\"If \\\"true\\\", indicates this organization is the person\'s prima" +
            "ry one (typically interpreted as current one).\"},\"startDate\":{\"type\":\"string\",\"d" +
            "escription\":\"The date the person joined this organization.\"},\"title\":{\"type\":\"st" +
            "ring\",\"description\":\"The person\'s job title or role within the organization.\"},\"" +
            "type\":{\"type\":\"string\",\"description\":\"The type of organization. Possible values " +
            "are:  \\n- \\\"work\\\" - Work. \\n- \\\"school\\\" - School.\"}}}},\"placesLived\":{\"type\":\"" +
            "array\",\"description\":\"A list of places where this person has lived.\",\"items\":{\"t" +
            "ype\":\"object\",\"properties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true" +
            "\\\", this place of residence is this person\'s primary residence.\"},\"value\":{\"type" +
            "\":\"string\",\"description\":\"A place where this person has lived. For example: \\\"Se" +
            "attle, WA\\\", \\\"Near Toronto\\\".\"}}}},\"relationshipStatus\":{\"type\":\"string\",\"descr" +
            "iption\":\"The person\'s relationship status. Possible values are:  \\n- \\\"single\\\" " +
            "- Person is single. \\n- \\\"in_a_relationship\\\" - Person is in a relationship. \\n-" +
            " \\\"engaged\\\" - Person is engaged. \\n- \\\"married\\\" - Person is married. \\n- \\\"its" +
            "_complicated\\\" - The relationship is complicated. \\n- \\\"open_relationship\\\" - Pe" +
            "rson is in an open relationship. \\n- \\\"widowed\\\" - Person is widowed. \\n- \\\"in_d" +
            "omestic_partnership\\\" - Person is in a domestic partnership. \\n- \\\"in_civil_unio" +
            "n\\\" - Person is in a civil union.\"},\"tagline\":{\"type\":\"string\",\"description\":\"Th" +
            "e brief description (tagline) of this person.\"},\"url\":{\"type\":\"string\",\"descript" +
            "ion\":\"The URL of this person\'s profile.\"},\"urls\":{\"type\":\"array\",\"description\":\"" +
            "A list of URLs for this person.\",\"items\":{\"type\":\"object\",\"properties\":{\"primary" +
            "\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", this URL is the person\'s primary" +
            " URL.\"},\"type\":{\"type\":\"string\",\"description\":\"The type of URL. Possible values " +
            "are:  \\n- \\\"home\\\" - URL for home. \\n- \\\"work\\\" - URL for work. \\n- \\\"blog\\\" - U" +
            "RL for blog. \\n- \\\"profile\\\" - URL for profile. \\n- \\\"other\\\" - Other.\"},\"value\"" +
            ":{\"type\":\"string\",\"description\":\"The URL value.\"}}}}}},\"PlusAclentryResource\":{\"" +
            "id\":\"PlusAclentryResource\",\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"" +
            "description\":\"The ID of the entry. For entries of type \\\"person\\\" or \\\"circle\\\"," +
            " this is the ID of the resource. For other types, this property is not set.\"},\"t" +
            "ype\":{\"type\":\"string\",\"description\":\"The type of entry describing to whom access" +
            " is granted. Possible values are:  \\n- \\\"person\\\" - Access to an individual. \\n-" +
            " \\\"circle\\\" - Access to members of a circle. \\n- \\\"myCircles\\\" - Access to membe" +
            "rs of all the person\'s circles. \\n- \\\"extendedCircles\\\" - Access to members of e" +
            "veryone in a person\'s circles, plus all of the people in their circles. \\n- \\\"pu" +
            "blic\\\" - Access to anyone on the web.\"}}}},\"resources\":{\"activities\":{\"methods\":" +
            "{\"get\":{\"id\":\"plus.activities.get\",\"path\":\"activities/{activityId}\",\"httpMethod\"" +
            ":\"GET\",\"description\":\"Get an activity.\",\"parameters\":{\"activityId\":{\"type\":\"stri" +
            "ng\",\"description\":\"The ID of the activity to get.\",\"required\":true,\"location\":\"p" +
            "ath\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alternative representat" +
            "ion type.\",\"default\":\"json\",\"enum\":[\"json\"],\"enumDescriptions\":[\"Use JSON format" +
            "\"],\"location\":\"query\"}},\"parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"Acti" +
            "vity\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"list\":{\"id\":\"plus." +
            "activities.list\",\"path\":\"people/{userId}/activities/{collection}\",\"httpMethod\":\"" +
            "GET\",\"description\":\"List all of the activities in the specified collection for a" +
            " particular user.\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies" +
            " an alternative representation type.\",\"default\":\"json\",\"enum\":[\"json\"],\"enumDesc" +
            "riptions\":[\"Use JSON format\"],\"location\":\"query\"},\"collection\":{\"type\":\"string\"," +
            "\"description\":\"The collection of activities to list.\",\"required\":true,\"enum\":[\"p" +
            "ublic\"],\"enumDescriptions\":[\"All public activities created by the specified user" +
            ".\"],\"location\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum" +
            " number of activities to include in the response, used for paging. For any respo" +
            ...
            "required\":true,\"pattern\":\"me|[0-9]+\",\"location\":\"path\"}},\"parameterOrder\":[\"user" +
            "Id\",\"collection\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"https://www.goog" +
            "leapis.com/auth/plus.me\"]},\"search\":{\"id\":\"plus.activities.search\",\"path\":\"activ" +
            "ities\",\"httpMethod\":\"GET\",\"description\":\"Search public activities.\",\"parameters\"" +
            ":{\"language\":{\"type\":\"string\",\"description\":\"Specify the preferred language to s" +
            "earch with. See search language code for available values.\",\"default\":\"\",\"locati" +
            "on\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum number of" +
            " activities to include in the response, used for paging. For any response, the a" +
            "ctual number returned may be less than the specified maxResults.\",\"default\":\"10\"" +
            ",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"20\",\"location\":\"query\"},\"orderBy\":{\"" +
            "type\":\"string\",\"description\":\"Specifies how to order search results.\",\"default\":" +
            "\"recent\",\"enum\":[\"best\",\"recent\"],\"enumDescriptions\":[\"Sort activities by releva" +
            "nce to the user, most relevant first.\",\"Sort activities by published date, most " +
            "recent first.\"],\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"" +
            "The continuation token, used to page through large result sets. To get the next " +
            "page of results, set this parameter to the value of \\\"nextPageToken\\\" from the p" +
            "revious response. This token may be of any length.\",\"location\":\"query\"},\"query\":" +
            ...
            ":{\"get\":{\"id\":\"plus.comments.get\",\"path\":\"comments/{commentId}\",\"httpMethod\":\"GE" +
            "T\",\"description\":\"Get a comment.\",\"parameters\":{\"commentId\":{\"type\":\"string\",\"de" +
            "scription\":\"The ID of the comment to get.\",\"required\":true,\"location\":\"path\"}},\"" +
            "parameterOrder\":[\"commentId\"],\"response\":{\"$ref\":\"Comment\"},\"scopes\":[\"https://w" +
            "ww.googleapis.com/auth/plus.me\"]},\"list\":{\"id\":\"plus.comments.list\",\"path\":\"acti" +
            "vities/{activityId}/comments\",\"httpMethod\":\"GET\",\"description\":\"List all of the " +
            "comments for an activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"descript" +
            "ion\":\"The ID of the activity to get comments for.\",\"required\":true,\"location\":\"p" +
            "ath\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alternative representat" +
            "ion type.\",\"default\":\"json\",\"enum\":[\"json\"],\"enumDescriptions\":[\"Use JSON format" +
            "\"],\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum" +
            " number of comments to include in the response, used for paging. For any respons" +
            "e, the actual number returned may be less than the specified maxResults.\",\"defau" +
            "lt\":\"20\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"100\",\"location\":\"query\"},\"pa" +
            ...
            ",\"parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"CommentFeed\"},\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/plus.me\"]}}},\"people\":{\"methods\":{\"get\":{\"id\":\"plu" +
            "s.people.get\",\"path\":\"people/{userId}\",\"httpMethod\":\"GET\",\"description\":\"Get a p" +
            "erson\'s profile.\",\"parameters\":{\"userId\":{\"type\":\"string\",\"description\":\"The ID " +
            "of the person to get the profile for. The special value \\\"me\\\" can be used to in" +
            "dicate the authenticated user.\",\"required\":true,\"pattern\":\"me|[0-9]+\",\"location\"" +
            ":\"path\"}},\"parameterOrder\":[\"userId\"],\"response\":{\"$ref\":\"Person\"},\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/plus.me\"]},\"listByActivity\":{\"id\":\"plus.people.lis" +
            "tByActivity\",\"path\":\"activities/{activityId}/people/{collection}\",\"httpMethod\":\"" +
            "GET\",\"description\":\"List all of the people in the specified collection for a par" +
            "ticular activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"description\":\"Th" +
            "e ID of the activity to get the list of people for.\",\"required\":true,\"location\":" +
            "\"path\"},\"collection\":{\"type\":\"string\",\"description\":\"The collection of people to" +
            " list.\",\"required\":true,\"enum\":[\"plusoners\",\"resharers\"],\"enumDescriptions\":[\"Li" +
            "st all people who have +1\'d this activity.\",\"List all people who have reshared t" +
            "his activity.\"],\"location\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"description\":" +
            "\"The maximum number of people to include in the response, used for paging. For a" +
            "ny response, the actual number returned may be less than the specified maxResult" +
            "s.\",\"default\":\"20\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"100\",\"location\":\"q" +
            ...
            ":\"query\"}},\"parameterOrder\":[\"activityId\",\"collection\"],\"response\":{\"$ref\":\"Peop" +
            "leFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"search\":{\"id\":\"p" +
            "lus.people.search\",\"path\":\"people\",\"httpMethod\":\"GET\",\"description\":\"Search all " +
            "public profiles.\",\"parameters\":{\"language\":{\"type\":\"string\",\"description\":\"Speci" +
            "fy the preferred language to search with. See search language codes for availabl" +
            "e values.\",\"default\":\"\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"desc" +
            "ription\":\"The maximum number of people to include in the response, used for pagi" +
            "ng. For any response, the actual number returned may be less than the specified " +
            "maxResults.\",\"default\":\"10\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"20\",\"loca" +
            ...
            "this parameter to the value of \\\"nextPageToken\\\" from the previous response. Thi" +
            "s token may be of any length.\",\"location\":\"query\"},\"query\":{\"type\":\"string\",\"des" +
            "cription\":\"Full-text search query string.\",\"required\":true,\"location\":\"query\"}}," +
            "\"parameterOrder\":[\"query\"],\"response\":{\"$ref\":\"PeopleFeed\"},\"scopes\":[\"https://w" +
            "ww.googleapis.com/auth/plus.me\"]}}}}}";
    ...
    public class ActivitiesResource {
        ...
        public class SearchRequest : Google.Apis.Requests.ServiceRequest<Google.Apis.Plus.v1.Data.ActivityFeed> {
            ...
            /// <summary>Specify the preferred language to search with. See search language code for available values.</summary>
