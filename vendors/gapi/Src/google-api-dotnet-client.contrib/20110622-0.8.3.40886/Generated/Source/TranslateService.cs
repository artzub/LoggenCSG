...
namespace Google.Apis.Translate.V2 {
    ...
    public class TranslationsResource {
        ...
        public virtual System.IO.Stream ListAsStream(Google.Apis.Util.Repeatable<string> q, string target, Format? format, string source) {
            string body = null;
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
            parameters["q"] = q;
            parameters["target"] = target;
        ...
        /// <param name="format">Optional - Must be one of the following values [html, text] - The format of the text</param>
        /// <param name="source">Optional - The source language of the text</param>
        public virtual Google.Apis.Translate.V2.Data.TranslationsListResponse List(Google.Apis.Util.Repeatable<string> q, string target, Format? format, string source) {
            string body = null;
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
            parameters["q"] = q;
            parameters["target"] = target;
