...
namespace Google.Apis.Prediction.V1_2.Data {
    ...
    public class HostedModelOutput : Google.Apis.Requests.IResponse {
...
namespace Google.Apis.Prediction.V1_2 {
    ...
    public class HostedmodelsResource {
        ...
        /// <summary>Submit input and request an output against a hosted model</summary>
        /// <param name="hostedModelName">Required - The name of a hosted model</param>
        public virtual Google.Apis.Prediction.V1_2.Data.HostedModelOutput Predict(Google.Apis.Prediction.V1_2.Data.Input body, string hostedModelName) {
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
            parameters["hostedModelName"] = hostedModelName;
            logger.Debug("Executing hostedmodels.predict");
            Google.Apis.Prediction.V1_2.Data.HostedModelOutput ret = this.service.JsonToObject<Google.Apis.Prediction.V1_2.Data.HostedModelOutput>(this.service.ExecuteRequest(HostedmodelsResource.Resource, "predict", this.service.ObjectToJson(body), parameters));
            logger.Debug("Done Executing hostedmodels.predict");
            return ret;
        }
    }
    ...
    public class TrainingResource {
        ...
        /// <summary>Begin training your model</summary>
        public virtual System.IO.Stream Insert(string body, System.Collections.Generic.IDictionary<string, object> parameters) {
            logger.Debug("Executing training.insert");
            System.IO.Stream ret = this.service.ExecuteRequest(TrainingResource.Resource, "insert", body, parameters);
            logger.Debug("Done Executing training.insert");
            return ret;
