...
namespace Google.Apis.Shopping.V1 {
    ...
    public class ProductsResource {
        ...
        public virtual System.IO.Stream GetAsStream(
                    ...
                    bool categoriesUseGcsConfig, 
                    bool debugEnabled, 
                    bool debugEnableLogging, 
                    bool debugSearchRequest, 
                    bool debugSearchResponse, 
                    string productFields, 
                    bool recommendationsEnabled, 
                    string recommendationsInclude, 
                    bool recommendationsUseGcsConfig, 
                    string taxonomy, 
                    string thumbnails) {
            string body = null;
        ...
        public virtual System.IO.Stream ListAsStream(
                    ...
                    bool debugEnabled, 
                    bool debugEnableLogging, 
                    bool debugGeocodeRequest, 
                    bool debugGeocodeResponse, 
                    bool debugRdcRequest, 
                    bool debugRdcResponse, 
                    bool debugSearchRequest, 
                    bool debugSearchResponse, 
                    string facetsDiscover, 
                    bool facetsEnabled, 
                    string facetsInclude, 
                    bool facetsUseGcsConfig, 
                    string language, 
                    long maxResults, 
                    string minAvailability, 
                    string productFields, 
                    bool promotionsEnabled, 
                    bool promotionsUseGcsConfig, 
                    string q, 
                    string rankBy, 
                    bool redirectsEnabled, 
                    bool redirectsUseGcsConfig, 
                    bool relatedQueriesEnabled, 
                    bool relatedQueriesUseGcsConfig, 
                    string restrictBy, 
                    bool safe, 
                    bool saytEnabled, 
                    bool saytUseGcsConfig, 
                    bool shelfSpaceAdsEnabled, 
                    long shelfSpaceAdsMaxResults, 
                    bool shelfSpaceAdsUseGcsConfig, 
                    bool spellingEnabled, 
                    bool spellingUseGcsConfig, 
                    long startIndex, 
                    string taxonomy, 
                    string thumbnails, 
                    string useCase) {
        ...
        /// <summary>Returns a single product</summary>
        /// <param name="accountIdValue">accountId - Required - Minimum value of 0 - Maximum value of 4294967295 - Merchant center account id</param>
        /// <param name="productIdValue">productId - Required - Id of product</param>
        /// <param name="productIdTypeValue">productIdType - Required - Type of productId</param>
        /// <param name="sourceValue">source - Required - Query source</param>
        public virtual System.IO.Stream Get(long accountId, string productId, string productIdType, string source, System.Collections.Generic.IDictionary<string, object> parameters) {
            string body = null;
            parameters["accountId"] = accountId;
            parameters["productId"] = productId;
            parameters["productIdType"] = productIdType;
        ...
        /// <summary>Returns a list of products and content modules</summary>
        /// <param name="sourceValue">source - Required - Query source</param>
        public virtual System.IO.Stream List(string source, System.Collections.Generic.IDictionary<string, object> parameters) {
            string body = null;
            parameters["source"] = source;
            logger.Debug("Executing products.list");
            System.IO.Stream ret = this.service.ExecuteRequest(ProductsResource.Resource, "list", body, parameters);
