...
namespace Google.Apis.Discovery.V1 {
    ...
    public class ApisResource {
        ...
        public virtual System.IO.Stream ListAsStream(string label, string name, bool preferred) {
            string body = null;
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
        ...
        /// <param name="name">Optional - Only include APIs with the given name.</param>
        /// <param name="preferred">Optional - Return only the preferred version of an API.</param>
        public virtual Google.Apis.Discovery.V1.Data.DirectoryList List(string label, string name, bool preferred) {
            string body = null;
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
            parameters["label"] = label;
            parameters["name"] = name;
