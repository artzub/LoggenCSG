...
namespace Google.Apis.CustomSearch.V1 {
    ...
    public class CseResource {
        ...
        public virtual System.IO.Stream ListAsStream(string q, string cref, string cx, string lr, string num, string safe, string sort, string start) {
            string body = null;
        ...
        /// <param name="sort">Optional - The sort expression to apply to the results</param>
        /// <param name="start">Optional - The index of the first result to return</param>
        public virtual Google.Apis.CustomSearch.V1.Data.Search List(string q, string cref, string cx, string lr, string num, string safe, string sort, string start) {
            string body = null;
            System.Collections.Generic.Dictionary<string, object> parameters = new System.Collections.Generic.Dictionary<string, object>();
            parameters["q"] = q;
            parameters["cref"] = cref;
        ...
        /// <summary>Returns metadata about the search performed, metadata about the custom search engine used for the search, and the search results.</summary>
        /// <param name="qValue">q - Required - Query</param>
        public virtual System.IO.Stream List(string q, System.Collections.Generic.IDictionary<string, object> parameters) {
            string body = null;
            parameters["q"] = q;
            logger.Debug("Executing cse.list");
            System.IO.Stream ret = this.service.ExecuteRequest(CseResource.Resource, "list", body, parameters);
