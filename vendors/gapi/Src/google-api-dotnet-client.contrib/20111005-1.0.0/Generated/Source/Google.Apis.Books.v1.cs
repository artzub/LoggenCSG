...
namespace Google.Apis.Books.v1 {
    ...
    public partial class BooksService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"books:v1\",\"name\":\"books\",\"version\":\"v1\"" +
            ...
            " formatted in HTML and includes simple formatting elements, such as b, i, and br" +
            " tags. (In LITE projection.)\"},\"dimensions\":{\"type\":\"object\",\"description\":\"Phys" +
            "ical dimensions of this volume.\",\"properties\":{\"height\":{\"type\":\"string\",\"descri" +
            "ption\":\"Height or length of this volume (in cm).\"},\"thickness\":{\"type\":\"string\"," +
            "\"description\":\"Thickness of this volume (in cm).\"},\"width\":{\"type\":\"string\",\"des" +
            "cription\":\"Width of this volume (in cm).\"}}},\"imageLinks\":{\"type\":\"object\",\"desc" +
            "ription\":\"A list of image links for all the sizes that are available. (In LITE p" +
            "rojection.)\",\"properties\":{\"extraLarge\":{\"type\":\"string\",\"description\":\"Image li" +
            "nk for extra large size (width of ~1280 pixels). (In LITE projection)\"},\"large\":" +
            "{\"type\":\"string\",\"description\":\"Image link for large size (width of ~800 pixels)" +
            ". (In LITE projection)\"},\"medium\":{\"type\":\"string\",\"description\":\"Image link for" +
            " medium size (width of ~575 pixels). (In LITE projection)\"},\"small\":{\"type\":\"str" +
            "ing\",\"description\":\"Image link for small size (width of ~300 pixels). (In LITE p" +
            "rojection)\"},\"smallThumbnail\":{\"type\":\"string\",\"description\":\"Image link for sma" +
            "ll thumbnail size (width of ~80 pixels). (In LITE projection)\"},\"thumbnail\":{\"ty" +
            "pe\":\"string\",\"description\":\"Image link for thumbnail size (width of ~128 pixels)" +
            ". (In LITE projection)\"}}},\"industryIdentifiers\":{\"type\":\"array\",\"description\":\"" +
            "Industry standard identifiers for this volume.\",\"items\":{\"type\":\"object\",\"proper" +
            "ties\":{\"identifier\":{\"type\":\"string\",\"description\":\"Industry specific volume ide" +
            "ntifier.\"},\"type\":{\"type\":\"string\",\"description\":\"Identifier type. Possible valu" +
            "es are ISBN_10, ISBN_13, ISSN and OTHER.\"}}}},\"infoLink\":{\"type\":\"string\",\"descr" +
            "iption\":\"URL to view information about this volume on the Google Books site. (In" +
            " LITE projection)\"},\"language\":{\"type\":\"string\",\"description\":\"Best language for" +
            " this volume (based on content). It is the two-letter ISO 639-1 code such as \'fr" +
            "\', \'en\', etc.\"},\"mainCategory\":{\"type\":\"string\",\"description\":\"The main category" +
            " to which this volume belongs. It will be the category from the categories list " +
            "returned below that has the highest weight.\"},\"pageCount\":{\"type\":\"integer\",\"des" +
            "cription\":\"Total number of pages.\",\"format\":\"int32\"},\"previewLink\":{\"type\":\"stri" +
            "ng\",\"description\":\"URL to preview this volume on the Google Books site.\"},\"print" +
            "Type\":{\"type\":\"string\",\"description\":\"Type of publication of this volume. Possib" +
            "le values are BOOK or MAGAZINE.\"},\"publishedDate\":{\"type\":\"string\",\"description\"" +
            ":\"Date of publication. (In LITE projection.)\"},\"publisher\":{\"type\":\"string\",\"des" +
            "cription\":\"Publisher of this volume. (In LITE projection.)\"},\"ratingsCount\":{\"ty" +
            "pe\":\"integer\",\"description\":\"The number of review ratings for this volume.\",\"for" +
            "mat\":\"int32\"},\"subtitle\":{\"type\":\"string\",\"description\":\"Volume subtitle. (In LI" +
            "TE projection.)\"},\"title\":{\"type\":\"string\",\"description\":\"Volume title. (In LITE" +
            " projection.)\"}}}}},\"Volumes\":{\"id\":\"Volumes\",\"type\":\"object\",\"properties\":{\"ite" +
            "ms\":{\"type\":\"array\",\"description\":\"A list of volumes.\",\"items\":{\"$ref\":\"Volume\"}" +
            "},\"kind\":{\"type\":\"string\",\"description\":\"Resource type.\",\"default\":\"books#volume" +
            "s\"},\"totalItems\":{\"type\":\"integer\",\"description\":\"Total number of volumes found." +
            " This might be greater than the number of volumes returned in this response if r" +
            "esults have been paginated.\",\"format\":\"int32\"}}}},\"resources\":{\"bookshelves\":{\"m" +
            "ethods\":{\"get\":{\"id\":\"books.bookshelves.get\",\"path\":\"users/{userId}/bookshelves/" +
            "{shelf}\",\"httpMethod\":\"GET\",\"description\":\"Retrieves a specific bookshelf for th" +
            "e specified user.\",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3" +
            "166-1 code to override the IP-based location.\",\"location\":\"query\"},\"shelf\":{\"typ" +
            "e\":\"string\",\"description\":\"Id of bookshelf to retrieve.\",\"required\":true,\"locati" +
            "on\":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the orig" +
            "inator of this request.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descript" +
            "ion\":\"Id of user for whom to retrieve bookshelves.\",\"required\":true,\"location\":\"" +
            "path\"}},\"parameterOrder\":[\"userId\",\"shelf\"],\"response\":{\"$ref\":\"Bookshelf\"},\"sco" +
            "pes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.bookshelves." +
            "list\",\"path\":\"users/{userId}/bookshelves\",\"httpMethod\":\"GET\",\"description\":\"Retr" +
            "ieves a list of public bookshelves for the specified user.\",\"parameters\":{\"count" +
            "ry\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based loc" +
            "ation.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to i" +
            ...
            "mes in a specific bookshelf for the specified user.\",\"parameters\":{\"country\":{\"t" +
            ...
            "r of results to return\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"},\"she" +
            "lf\":{\"type\":\"string\",\"description\":\"Id of bookshelf to retrieve volumes.\",\"requi" +
            ...
            "\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"d" +
            "escription\":\"Id of user for whom to retrieve bookshelf volumes.\",\"required\":true" +
            ",\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"shelf\"],\"response\":{\"$ref\":\"Vol" +
            "umes\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}},\"mylibrary\":{\"res" +
            "ources\":{\"bookshelves\":{\"methods\":{\"addVolume\":{\"id\":\"books.mylibrary.bookshelve" +
            "s.addVolume\",\"path\":\"mylibrary/bookshelves/{shelf}/addVolume\",\"httpMethod\":\"POST" +
            "\",\"description\":\"Adds a volume to a bookshelf.\",\"parameters\":{\"country\":{\"type\":" +
            "\"string\",\"description\":\"ISO-3166-1 code to override the IP-based location.\",\"loc" +
            "ation\":\"query\"},\"shelf\":{\"type\":\"string\",\"description\":\"Id of bookshelf to which" +
            " to add a volume.\",\"required\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\"," +
            "\"description\":\"String to identify the originator of this request.\",\"location\":\"q" +
            "uery\"},\"volumeId\":{\"type\":\"string\",\"description\":\"Id of volume to add.\",\"require" +
            "d\":true,\"location\":\"query\"}},\"parameterOrder\":[\"shelf\",\"volumeId\"],\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/books\"]},\"clearVolumes\":{\"id\":\"books.mylibrary.boo" +
            "kshelves.clearVolumes\",\"path\":\"mylibrary/bookshelves/{shelf}/clearVolumes\",\"http" +
            "Method\":\"POST\",\"description\":\"Clears all volumes from a bookshelf.\",\"parameters\"" +
            ":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-b" +
            "ased location.\",\"location\":\"query\"},\"shelf\":{\"type\":\"string\",\"description\":\"Id o" +
            "f bookshelf from which to remove a volume.\",\"required\":true,\"location\":\"path\"},\"" +
            "source\":{\"type\":\"string\",\"description\":\"String to identify the originator of thi" +
            "s request.\",\"location\":\"query\"}},\"parameterOrder\":[\"shelf\"],\"scopes\":[\"https://w" +
            "ww.googleapis.com/auth/books\"]},\"get\":{\"id\":\"books.mylibrary.bookshelves.get\",\"p" +
            "ath\":\"mylibrary/bookshelves/{shelf}\",\"httpMethod\":\"GET\",\"description\":\"Retrieves" +
            " a specific bookshelf belonging to the authenticated user.\",\"parameters\":{\"count" +
            "ry\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based loc" +
            "ation.\",\"location\":\"query\"},\"shelf\":{\"type\":\"string\",\"description\":\"Id of booksh" +
            "elf to retrieve.\",\"required\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\",\"" +
            "description\":\"String to identify the originator of this request.\",\"location\":\"qu" +
            "ery\"}},\"parameterOrder\":[\"shelf\"],\"response\":{\"$ref\":\"Bookshelf\"},\"scopes\":[\"htt" +
            "ps://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.mylibrary.bookshelves." +
            "list\",\"path\":\"mylibrary/bookshelves\",\"httpMethod\":\"GET\",\"description\":\"Retrieves" +
            " a list of bookshelves belonging to the authenticated user.\",\"parameters\":{\"coun" +
            "try\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based lo" +
            "cation.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to " +
            "identify the originator of this request.\",\"location\":\"query\"}},\"response\":{\"$ref" +
            "\":\"Bookshelves\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"removeVolu" +
            ...
            "string\",\"description\":\"Id of volume to remove.\",\"required\":true,\"location\":\"quer" +
            "y\"}},\"parameterOrder\":[\"shelf\",\"volumeId\"],\"scopes\":[\"https://www.googleapis.com" +
            "/auth/books\"]}},\"resources\":{\"volumes\":{\"methods\":{\"list\":{\"id\":\"books.mylibrary" +
            ".bookshelves.volumes.list\",\"path\":\"mylibrary/bookshelves/{shelf}/volumes\",\"httpM" +
            "ethod\":\"GET\",\"description\":\"Gets volume information for volumes on a bookshelf.\"" +
            ",\"parameters\":{\"country\":{\"type\":\"string\",\"description\":\"ISO-3166-1 code to over" +
            "ride the IP-based location.\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\"," +
            "\"description\":\"Maximum number of results to return\",\"format\":\"uint32\",\"minimum\":" +
            "\"0\",\"location\":\"query\"},\"projection\":{\"type\":\"string\",\"description\":\"Restrict in" +
            "formation returned to a set of selected fields.\",\"enum\":[\"full\",\"lite\"],\"enumDes" +
            "criptions\":[\"Includes all volume data.\",\"Includes a subset of fields in volumeIn" +
            "fo and accessInfo.\"],\"location\":\"query\"},\"q\":{\"type\":\"string\",\"description\":\"Ful" +
            "l-text search query string in this bookshelf.\",\"location\":\"query\"},\"shelf\":{\"typ" +
            "e\":\"string\",\"description\":\"The bookshelf id or name retrieve volumes for.\",\"loca" +
            "tion\":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the or" +
            "iginator of this request.\",\"location\":\"query\"},\"startIndex\":{\"type\":\"integer\",\"d" +
            "escription\":\"Index of the first element to return (starts at 0)\",\"format\":\"uint3" +
            "2\",\"minimum\":\"0\",\"location\":\"query\"}},\"parameterOrder\":[\"shelf\"],\"response\":{\"$r" +
            "ef\":\"Volumes\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}}}},\"volume" +
            ...
            "on\":\"Identifier of partner for whom to brand results.\",\"location\":\"query\"},\"proj" +
            "ection\":{\"type\":\"string\",\"description\":\"Restrict information returned to a set o" +
            "f selected fields.\",\"enum\":[\"full\",\"lite\"],\"enumDescriptions\":[\"Includes all vol" +
            "ume data.\",\"Includes a subset of fields in volumeInfo and accessInfo.\"],\"locatio" +
            "n\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the orig" +
            "inator of this request.\",\"location\":\"query\"},\"volumeId\":{\"type\":\"string\",\"descri" +
            "ption\":\"Id of volume to retrieve.\",\"required\":true,\"location\":\"path\"}},\"paramete" +
            "rOrder\":[\"volumeId\"],\"response\":{\"$ref\":\"Volume\"},\"scopes\":[\"https://www.googlea" +
            "pis.com/auth/books\"]},\"list\":{\"id\":\"books.volumes.list\",\"path\":\"volumes\",\"httpMe" +
            "thod\":\"GET\",\"description\":\"Performs a book search.\",\"parameters\":{\"country\":{\"ty" +
            "pe\":\"string\",\"description\":\"ISO-3166-1 code to override the IP-based location.\"," +
            "\"location\":\"query\"},\"download\":{\"type\":\"string\",\"description\":\"Restrict to volum" +
            "es by download availability.\",\"enum\":[\"epub\"],\"enumDescriptions\":[\"All volumes w" +
            "ith epub.\"],\"location\":\"query\"},\"filter\":{\"type\":\"string\",\"description\":\"Filter " +
            "search results.\",\"enum\":[\"ebooks\",\"free-ebooks\",\"full\",\"paid-ebooks\",\"partial\"]," +
            "\"enumDescriptions\":[\"All Google eBooks.\",\"Google eBook with full volume text vie" +
            "wability.\",\"Public can view entire volume text.\",\"Google eBook with a price.\",\"P" +
            "ublic able to see parts of text.\"],\"location\":\"query\"},\"langRestrict\":{\"type\":\"s" +
            "tring\",\"description\":\"Restrict results to books with this language code.\",\"locat" +
            "ion\":\"query\"},\"libraryRestrict\":{\"type\":\"string\",\"description\":\"Restrict search " +
            "to this user\'s library.\",\"enum\":[\"my-library\",\"no-restrict\"],\"enumDescriptions\":" +
            "[\"Restrict to the user\'s library, any shelf.\",\"Do not restrict based on user\'s l" +
            "ibrary.\"],\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maxi" +
            "mum number of results to return.\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"40\"" +
            ",\"location\":\"query\"},\"orderBy\":{\"type\":\"string\",\"description\":\"Sort search resul" +
            "ts.\",\"enum\":[\"newest\",\"relevance\"],\"enumDescriptions\":[\"Most recently published." +
            "\",\"Relevance to search terms.\"],\"location\":\"query\"},\"partner\":{\"type\":\"string\",\"" +
            "description\":\"Identifier of partner for whom to restrict and brand results.\",\"lo" +
            "cation\":\"query\"},\"printType\":{\"type\":\"string\",\"description\":\"Restrict to books o" +
            "r magazines.\",\"enum\":[\"all\",\"books\",\"magazines\"],\"enumDescriptions\":[\"All volume" +
            " content types.\",\"Just books.\",\"Just magazines.\"],\"location\":\"query\"},\"projectio" +
            ...
            "uery\"},\"q\":{\"type\":\"string\",\"description\":\"Full-text search query string.\",\"requ" +
            "ired\":true,\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String t" +
            "o identify the originator of this request.\",\"location\":\"query\"},\"startIndex\":{\"t" +
            "ype\":\"integer\",\"description\":\"Index of the first result to return (starts at 0)\"" +
            ",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"}},\"parameterOrder\":[\"q\"],\"re" +
