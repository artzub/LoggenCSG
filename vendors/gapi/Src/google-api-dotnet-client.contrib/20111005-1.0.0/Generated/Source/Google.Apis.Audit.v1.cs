...
namespace Google.Apis.Audit.v1 {
    ...
    public partial class AuditService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"audit:v1\",\"name\":\"audit\",\"version\":\"v1\"" +
            ...
            "mail address of the user who performed the action.\",\"location\":\"query\"},\"actorIp" +
            "Address\":{\"type\":\"string\",\"description\":\"IP Address of host where the event was " +
            "performed. Supports both IPv4 and IPv6 addresses.\",\"location\":\"query\"},\"applicat" +
            "ionId\":{\"type\":\"string\",\"description\":\"Application ID of the application on whic" +
            "h the event was performed.\",\"required\":true,\"format\":\"int64\",\"location\":\"path\"}," +
            ...
            "description\":\"Number of activity records to be shown in each page.\",\"format\":\"in" +
            "t32\",\"minimum\":\"1\",\"maximum\":\"1000\",\"location\":\"query\"},\"parameters\":{\"type\":\"st" +
            "ring\",\"description\":\"Event parameters in the form [parameter1 name]:[parameter1 " +
            "value],[parameter2 name]:[parameter2 value],...\",\"location\":\"query\"},\"startTime\"" +
            ":{\"type\":\"string\",\"description\":\"Return events which occured at or after this ti" +
            "me.\",\"location\":\"query\"}},\"parameterOrder\":[\"customerId\",\"applicationId\"],\"respo" +
            "nse\":{\"$ref\":\"Activities\"}}}}}}";
