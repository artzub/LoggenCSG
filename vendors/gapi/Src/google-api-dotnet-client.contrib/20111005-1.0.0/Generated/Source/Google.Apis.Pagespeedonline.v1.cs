...
namespace Google.Apis.Pagespeedonline.v1 {
    ...
    public partial class PagespeedonlineService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"pagespeedonline:v1\",\"name\":\"pagespeedon" +
            ...
            "tations and line breaks.\",\"default\":\"true\",\"location\":\"query\"},\"userIp\":{\"type\":" +
            ...
            "Result\":{\"id\":\"Result\",\"type\":\"object\",\"properties\":{\"formattedResults\":{\"type\":" +
            "\"object\",\"description\":\"Localized Page Speed results. Contains a ruleResults ent" +
            "ry for each Page Speed rule instantiated and run by the server.\",\"properties\":{\"" +
            "locale\":{\"type\":\"string\",\"description\":\"The locale of the formattedResults, e.g." +
            " \\\"en_US\\\".\"},\"ruleResults\":{\"type\":\"object\",\"description\":\"Dictionary of format" +
            "ted rule results, with one entry for each Page Speed rule instantiated and run b" +
            "y the server.\",\"additionalProperties\":{\"type\":\"object\",\"description\":\"The enum-l" +
            "ike identifier for this rule. For instance \\\"EnableKeepAlive\\\" or \\\"AvoidCssImpo" +
            "rt\\\". Not localized.\",\"properties\":{\"localizedRuleName\":{\"type\":\"string\",\"descri" +
            "ption\":\"Localized name of the rule, intended for presentation to a user.\"},\"rule" +
            "Impact\":{\"type\":\"number\",\"description\":\"The impact (unbounded floating point val" +
            "ue) that implementing the suggestions for this rule would have on making the pag" +
            "e faster. Impact is comparable between rules to determine which rule\'s suggestio" +
            "ns would have a higher or lower impact on making a page faster. For instance, if" +
            " enabling compression would save 1MB, while optimizing images would save 500kB, " +
            "the enable compression rule would have 2x the impact of the image optimization r" +
            "ule, all other things being equal.\",\"format\":\"double\"},\"ruleScore\":{\"type\":\"inte" +
            "ger\",\"description\":\"The score (0-100) for this rule. The rule score indicates ho" +
            "w well a page implements the recommendations for the given rule. For instance, i" +
            "f none of the compressible resources on a page are compressed, the rule score wo" +
            "uld be 0, while if all of the compressible resources on a page are compressed, t" +
            "he rule score would be 100.\",\"format\":\"int32\"},\"urlBlocks\":{\"type\":\"array\",\"desc" +
            "ription\":\"List of blocks of URLs. Each block may contain a heading and a list of" +
            " URLs. Each URL may optionally include additional details.\",\"items\":{\"type\":\"obj" +
            "ect\",\"properties\":{\"header\":{\"type\":\"object\",\"description\":\"Heading to be displa" +
            "yed with the list of URLs.\",\"properties\":{\"args\":{\"type\":\"array\",\"description\":\"" +
            "List of arguments for the format string.\",\"items\":{\"type\":\"object\",\"properties\":" +
            "{\"type\":{\"type\":\"string\",\"description\":\"Type of argument. One of URL, STRING_LIT" +
            "ERAL, INT_LITERAL, BYTES, or DURATION.\"},\"value\":{\"type\":\"string\",\"description\":" +
            "\"Argument value, as a localized string.\"}}}},\"format\":{\"type\":\"string\",\"descript" +
            "ion\":\"A localized format string with $N placeholders, where N is the 1-indexed a" +
            "rgument number, e.g. \'Minifying the following $1 resources would save a total of" +
            " $2 bytes\'.\"}}},\"urls\":{\"type\":\"array\",\"description\":\"List of entries that provi" +
            "de information about URLs in the url block. Optional.\",\"items\":{\"type\":\"object\"," +
            "\"properties\":{\"details\":{\"type\":\"array\",\"description\":\"List of entries that prov" +
            "ide additional details about a single URL. Optional.\",\"items\":{\"type\":\"object\",\"" +
            "properties\":{\"args\":{\"type\":\"array\",\"description\":\"List of arguments for the for" +
            "mat string.\",\"items\":{\"type\":\"object\",\"properties\":{\"type\":{\"type\":\"string\",\"des" +
            "cription\":\"Type of argument. One of URL, STRING_LITERAL, INT_LITERAL, BYTES, or " +
            "DURATION.\"},\"value\":{\"type\":\"string\",\"description\":\"Argument value, as a localiz" +
            "ed string.\"}}}},\"format\":{\"type\":\"string\",\"description\":\"A localized format stri" +
            "ng with $N placeholders, where N is the 1-indexed argument number, e.g. \'Unneces" +
            "sary metadata for this resource adds an additional $1 bytes to its download size" +
            "\'.\"}}}},\"result\":{\"type\":\"object\",\"description\":\"A format string that gives info" +
            "rmation about the URL, and a list of arguments for that format string.\",\"propert" +
            "ies\":{\"args\":{\"type\":\"array\",\"description\":\"List of arguments for the format str" +
            "ing.\",\"items\":{\"type\":\"object\",\"properties\":{\"type\":{\"type\":\"string\",\"descriptio" +
            "n\":\"Type of argument. One of URL, STRING_LITERAL, INT_LITERAL, BYTES, or DURATIO" +
            "N.\"},\"value\":{\"type\":\"string\",\"description\":\"Argument value, as a localized stri" +
            "ng.\"}}}},\"format\":{\"type\":\"string\",\"description\":\"A localized format string with" +
            " $N placeholders, where N is the 1-indexed argument number, e.g. \'Minifying the " +
            "resource at URL $1 can save $2 bytes\'.\"}}}}}}}}}}}}}},\"id\":{\"type\":\"string\",\"des" +
            "cription\":\"Canonicalized and final URL for the document, after following page re" +
            "directs (if any).\"},\"invalidRules\":{\"type\":\"array\",\"description\":\"List of rules " +
            "that were specified in the request, but which the server did not know how to ins" +
            "tantiate.\",\"items\":{\"type\":\"string\"}},\"kind\":{\"type\":\"string\",\"description\":\"Kin" +
            "d of result.\",\"default\":\"pagespeedonline#result\"},\"pageStats\":{\"type\":\"object\",\"" +
            "description\":\"Summary statistics for the page, such as number of JavaScript byte" +
            "s, number of HTML bytes, etc.\",\"properties\":{\"cssResponseBytes\":{\"type\":\"string\"" +
            ",\"description\":\"Number of uncompressed response bytes for CSS resources on the p" +
            "age.\",\"format\":\"int64\"},\"flashResponseBytes\":{\"type\":\"string\",\"description\":\"Num" +
            "ber of response bytes for flash resources on the page.\",\"format\":\"int64\"},\"htmlR" +
            "esponseBytes\":{\"type\":\"string\",\"description\":\"Number of uncompressed response by" +
            "tes for the main HTML document and all iframes on the page.\",\"format\":\"int64\"},\"" +
            "imageResponseBytes\":{\"type\":\"string\",\"description\":\"Number of response bytes for" +
            " image resources on the page.\",\"format\":\"int64\"},\"javascriptResponseBytes\":{\"typ" +
            "e\":\"string\",\"description\":\"Number of uncompressed response bytes for JS resource" +
            "s on the page.\",\"format\":\"int64\"},\"numberCssResources\":{\"type\":\"integer\",\"descri" +
            "ption\":\"Number of CSS resources referenced by the page.\",\"format\":\"int32\"},\"numb" +
            "erHosts\":{\"type\":\"integer\",\"description\":\"Number of unique hosts referenced by t" +
            "he page.\",\"format\":\"int32\"},\"numberJsResources\":{\"type\":\"integer\",\"description\":" +
            "\"Number of JavaScript resources referenced by the page.\",\"format\":\"int32\"},\"numb" +
            "erResources\":{\"type\":\"integer\",\"description\":\"Number of HTTP resources loaded by" +
            " the page.\",\"format\":\"int32\"},\"numberStaticResources\":{\"type\":\"integer\",\"descrip" +
            "tion\":\"Number of static (i.e. cacheable) resources on the page.\",\"format\":\"int32" +
            "\"},\"otherResponseBytes\":{\"type\":\"string\",\"description\":\"Number of response bytes" +
            " for other resources on the page.\",\"format\":\"int64\"},\"textResponseBytes\":{\"type\"" +
            ":\"string\",\"description\":\"Number of uncompressed response bytes for text resource" +
            "s not covered by other statistics (i.e non-HTML, non-script, non-CSS resources) " +
            "on the page.\",\"format\":\"int64\"},\"totalRequestBytes\":{\"type\":\"string\",\"descriptio" +
            "n\":\"Total size of all request bytes sent by the page.\",\"format\":\"int64\"}}},\"resp" +
            "onseCode\":{\"type\":\"integer\",\"description\":\"Response code for the document. 200 i" +
            "ndicates a normal page load. 4xx/5xx indicates an error.\",\"format\":\"int32\"},\"sco" +
            "re\":{\"type\":\"integer\",\"description\":\"The Page Speed Score (0-100), which indicat" +
            "es how much faster a page could be. A high score indicates little room for impro" +
            "vement, while a lower score indicates more room for improvement.\",\"format\":\"int3" +
            "2\"},\"title\":{\"type\":\"string\",\"description\":\"Title of the page, as displayed in t" +
            "he browser\'s title bar.\"},\"version\":{\"type\":\"object\",\"description\":\"The version " +
            "of the Page Speed SDK used to generate these results.\",\"properties\":{\"major\":{\"t" +
            "ype\":\"integer\",\"description\":\"The major version number of the Page Speed SDK use" +
            "d to generate these results.\",\"format\":\"int32\"},\"minor\":{\"type\":\"integer\",\"descr" +
            "iption\":\"The minor version number of the Page Speed SDK used to generate these r" +
            "esults.\",\"format\":\"int32\"}}}}}},\"resources\":{\"pagespeedapi\":{\"methods\":{\"runpage" +
            "speed\":{\"id\":\"pagespeedonline.pagespeedapi.runpagespeed\",\"path\":\"runPagespeed\",\"" +
            "httpMethod\":\"GET\",\"description\":\"Runs Page Speed analysis on the page at the spe" +
            "cified URL, and returns a Page Speed score, a list of suggestions to make that p" +
            "age faster, and other information.\",\"parameters\":{\"locale\":{\"type\":\"string\",\"des" +
            "cription\":\"The locale used to localize formatted results\",\"pattern\":\"[a-zA-Z]+(_" +
            "[a-zA-Z]+)?\",\"location\":\"query\"},\"rule\":{\"type\":\"string\",\"description\":\"A Page S" +
            "peed rule to run; if none are given, all rules are run\",\"pattern\":\"[a-zA-Z]+\",\"r" +
            "epeated\":true,\"location\":\"query\"},\"strategy\":{\"type\":\"string\",\"description\":\"The" +
            " analysis strategy to use\",\"enum\":[\"desktop\",\"mobile\"],\"enumDescriptions\":[\"Fetc" +
            "h and analyze the URL for desktop browsers\",\"Fetch and analyze the URL for mobil" +
            "e devices\"],\"location\":\"query\"},\"url\":{\"type\":\"string\",\"description\":\"The URL to" +
            " fetch and analyze\",\"required\":true,\"pattern\":\"http(s)?://.*\",\"location\":\"query\"" +
            "}},\"parameterOrder\":[\"url\"],\"response\":{\"$ref\":\"Result\"}}}}}}";
