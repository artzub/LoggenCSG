    ...
    public class Activity : Google.Apis.Requests.IDirectResponseSchema {
        ...
        public class ObjectData {
            ...
            public class PlusonersData {
                ...
                /// <summary>The URL for collection of people who +1&apos;d this activity.</summary>
...
namespace Google.Apis.Plus.v1 {
    ...
    public partial class PlusService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"plus:v1\",\"name\":\"plus\",\"version\":\"v1\",\"" +
            ...
            "ault\":\"true\",\"location\":\"query\"},\"userIp\":{\"type\":\"string\",\"description\":\"IP add" +
            "ress of the site where the request originates. Use this if you want to enforce p" +
            "er-user limits.\",\"location\":\"query\"}},\"auth\":{\"oauth2\":{\"scopes\":{\"https://www.g" +
            "oogleapis.com/auth/plus.me\":{\"description\":\"Know who you are on Google\"}}}},\"sch" +
            "emas\":{\"Acl\":{\"id\":\"Acl\",\"type\":\"object\",\"properties\":{\"description\":{\"type\":\"st" +
            "ring\",\"description\":\"Description of the access granted, suitable for display.\"}," +
            "\"items\":{\"type\":\"array\",\"description\":\"The list of access entries.\",\"items\":{\"$r" +
            "ef\":\"PlusAclentryResource\"}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies t" +
            "his resource as a collection of access controls. Value: \\\"plus#acl\\\".\",\"default\"" +
            ":\"plus#acl\"}}},\"Activity\":{\"id\":\"Activity\",\"type\":\"object\",\"properties\":{\"access" +
            "\":{\"$ref\":\"Acl\",\"description\":\"Identifies who has access to see this activity.\"}" +
            ",\"actor\":{\"type\":\"object\",\"description\":\"The person who performed this activity." +
            "\",\"properties\":{\"displayName\":{\"type\":\"string\",\"description\":\"The name of the ac" +
            "tor, suitable for display.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of the " +
            "actor\'s person resource.\"},\"image\":{\"type\":\"object\",\"description\":\"The image rep" +
            "resentation of the actor.\",\"properties\":{\"url\":{\"type\":\"string\",\"description\":\"T" +
            "he URL of the actor\'s profile photo. To re-size the image and crop it to a squar" +
            "e, append the query string ?sz=x, where x is the dimension in pixels of each sid" +
            "e.\"}}},\"url\":{\"type\":\"string\",\"description\":\"The link to the actor\'s Google prof" +
            "ile.\"}}},\"address\":{\"type\":\"string\",\"description\":\"Street address where this act" +
            "ivity occurred.\"},\"annotation\":{\"type\":\"string\",\"description\":\"Additional conten" +
            "t added by the person who shared this activity, applicable only when resharing a" +
            "n activity.\"},\"crosspostSource\":{\"type\":\"string\",\"description\":\"If this activity" +
            " is a crosspost from another system, this property specifies the ID of the origi" +
            "nal activity.\"},\"geocode\":{\"type\":\"string\",\"description\":\"Latitude and longitude" +
            " where this activity occurred. Format is latitude followed by longitude, space s" +
            "eparated.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of this activity.\"},\"kin" +
            "d\":{\"type\":\"string\",\"description\":\"Identifies this resource as an activity. Valu" +
            "e: \\\"plus#activity\\\".\",\"default\":\"plus#activity\"},\"object\":{\"type\":\"object\",\"des" +
            "cription\":\"The object of this activity.\",\"properties\":{\"actor\":{\"type\":\"object\"," +
            "\"description\":\"If this activity\'s object is itself another activity (for example" +
            ", when a person reshares an activity), this property specifies the original acti" +
            "vity\'s actor.\",\"properties\":{\"displayName\":{\"type\":\"string\",\"description\":\"The o" +
            "riginal actor\'s name, suitable for display.\"},\"id\":{\"type\":\"string\",\"description" +
            "\":\"ID of the original actor.\"},\"image\":{\"type\":\"object\",\"description\":\"The image" +
            " representation of the original actor.\",\"properties\":{\"url\":{\"type\":\"string\",\"de" +
            "scription\":\"A URL that points to a thumbnail photo of the original actor.\"}}},\"u" +
            "rl\":{\"type\":\"string\",\"description\":\"A link to the original actor\'s Google profil" +
            "e.\"}}},\"attachments\":{\"type\":\"array\",\"description\":\"The media objects attached t" +
            "o this activity.\",\"items\":{\"type\":\"object\",\"properties\":{\"content\":{\"type\":\"stri" +
            "ng\",\"description\":\"If the attachment is an article, this property contains a sni" +
            "ppet of text from the article.\"},\"displayName\":{\"type\":\"string\",\"description\":\"T" +
            "he title of the attachment (such as a photo caption or an article title).\"},\"emb" +
            "ed\":{\"type\":\"object\",\"description\":\"If the attachment is a video, the embeddable" +
            " link.\",\"properties\":{\"type\":{\"type\":\"string\",\"description\":\"Media type of the l" +
            "ink.\"},\"url\":{\"type\":\"string\",\"description\":\"URL of the link.\"}}},\"fullImage\":{\"" +
            "type\":\"object\",\"description\":\"The full image url for photo attachments.\",\"proper" +
            "ties\":{\"height\":{\"type\":\"integer\",\"description\":\"The height, in pixels, of the l" +
            "inked resource.\",\"format\":\"uint32\"},\"type\":{\"type\":\"string\",\"description\":\"Media" +
            " type of the link.\"},\"url\":{\"type\":\"string\",\"description\":\"URL of the link.\"},\"w" +
            "idth\":{\"type\":\"integer\",\"description\":\"The width, in pixels, of the linked resou" +
            "rce.\",\"format\":\"uint32\"}}},\"id\":{\"type\":\"string\",\"description\":\"The ID of the me" +
            "dia object\'s resource.\"},\"image\":{\"type\":\"object\",\"description\":\"The preview ima" +
            "ge for photos or videos.\",\"properties\":{\"height\":{\"type\":\"integer\",\"description\"" +
            ":\"The height, in pixels, of the linked resource.\",\"format\":\"uint32\"},\"type\":{\"ty" +
            "pe\":\"string\",\"description\":\"Media type of the link.\"},\"url\":{\"type\":\"string\",\"de" +
            "scription\":\"URL of the link.\"},\"width\":{\"type\":\"integer\",\"description\":\"The widt" +
            "h, in pixels, of the linked resource.\",\"format\":\"uint32\"}}},\"objectType\":{\"type\"" +
            ":\"string\",\"description\":\"The type of media object. Possible values are:  \\n- \\\"p" +
            "hoto\\\" - A photo. \\n- \\\"video\\\" - A video. \\n- \\\"article\\\" - An article, specifi" +
            "ed by a link.\"},\"url\":{\"type\":\"string\",\"description\":\"The link to the attachment" +
            ", should be of type text/html.\"}}}},\"content\":{\"type\":\"string\",\"description\":\"Th" +
            "e HTML-formatted content, suitable for display. When creating or updating an act" +
            "ivity, this value must be supplied as plain text in the request. If successful, " +
            "the response will contain the HTML-formatted content. When updating an activity," +
            " use originalContent as the starting value, then assign the updated text to this" +
            " property.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of the object. When res" +
            "haring an activity, this is the ID of the activity being reshared.\"},\"objectType" +
            "\":{\"type\":\"string\",\"description\":\"The type of the object. Possible values are:  " +
            "\\n- \\\"note\\\" - Textual content. \\n- \\\"activity\\\" - A Google+ activity.\"},\"origin" +
            "alContent\":{\"type\":\"string\",\"description\":\"The content (text) as provided by the" +
            " author, stored without any HTML formatting. When updating an activity\'s content" +
            ", use the value of originalContent as the starting point from which to make edit" +
            "s.\"},\"plusoners\":{\"type\":\"object\",\"description\":\"People who +1\'d this activity.\"" +
            ",\"properties\":{\"selfLink\":{\"type\":\"string\",\"description\":\"The URL for collection" +
            " of people who +1\'d this activity.\"},\"totalItems\":{\"type\":\"integer\",\"description" +
            "\":\"Total number of people who +1\'d this activity.\",\"format\":\"uint32\"}}},\"replies" +
            "\":{\"type\":\"object\",\"description\":\"Comments in reply to this activity.\",\"properti" +
            "es\":{\"selfLink\":{\"type\":\"string\",\"description\":\"The URL for the collection of co" +
            "mments in reply to this activity.\"},\"totalItems\":{\"type\":\"integer\",\"description\"" +
            ":\"Total number of comments on this activity.\",\"format\":\"uint32\"}}},\"resharers\":{" +
            "\"type\":\"object\",\"description\":\"People who reshared this activity.\",\"properties\":" +
            "{\"selfLink\":{\"type\":\"string\",\"description\":\"The URL for the collection of reshar" +
            "ers.\"},\"totalItems\":{\"type\":\"integer\",\"description\":\"Total number of people who " +
            "reshared this activity.\",\"format\":\"uint32\"}}},\"url\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The URL that points to the linked resource.\"}}},\"placeId\":{\"type\":\"string\",\"" +
            "description\":\"ID of the place where this activity occurred.\"},\"placeName\":{\"type" +
            "\":\"string\",\"description\":\"Name of the place where this activity occurred.\"},\"pla" +
            "ceholder\":{\"type\":\"boolean\",\"description\":\"True if this activity is a placeholde" +
            "r.\"},\"provider\":{\"type\":\"object\",\"description\":\"The service provider that initia" +
            "lly published this activity.\",\"properties\":{\"title\":{\"type\":\"string\",\"descriptio" +
            "n\":\"Name of the service provider.\"}}},\"published\":{\"type\":\"string\",\"description\"" +
            ":\"The time at which this activity was initially published. Formatted as an RFC 3" +
            "339 timestamp.\",\"format\":\"date-time\"},\"radius\":{\"type\":\"string\",\"description\":\"R" +
            "adius, in meters, of the region where this activity occurred, centered at the la" +
            "titude and longitude identified in geocode.\"},\"title\":{\"type\":\"string\",\"descript" +
            "ion\":\"Title of this activity.\"},\"updated\":{\"type\":\"string\",\"description\":\"The ti" +
            "me at which this activity was last updated. Formatted as an RFC 3339 timestamp.\"" +
            ",\"format\":\"date-time\"},\"url\":{\"type\":\"string\",\"description\":\"The link to this ac" +
            "tivity.\"},\"verb\":{\"type\":\"string\",\"description\":\"This activity\'s verb, indicatin" +
            "g what action was performed. Possible values are:  \\n- \\\"post\\\" - Publish conten" +
            "t to the stream. \\n- \\\"checkin\\\" - Check in to a location. \\n- \\\"share\\\" - Resha" +
            "re an activity.\"}}},\"ActivityFeed\":{\"id\":\"ActivityFeed\",\"type\":\"object\",\"propert" +
            "ies\":{\"id\":{\"type\":\"string\",\"description\":\"The ID of this collection of activiti" +
            "es.\"},\"items\":{\"type\":\"array\",\"description\":\"The activities in this page of resu" +
            "lts.\",\"items\":{\"$ref\":\"Activity\"}},\"kind\":{\"type\":\"string\",\"description\":\"Identi" +
            "fies this resource as a collection of activities. Value: \\\"plus#activityFeed\\\".\"" +
            ",\"default\":\"plus#activityFeed\"},\"nextLink\":{\"type\":\"string\",\"description\":\"Link " +
            "to the next page of activities.\"},\"nextPageToken\":{\"type\":\"string\",\"description\"" +
            ":\"The continuation token, used to page through large result sets. Provide this v" +
            "alue in a subsequent request to return the next page of results.\"},\"selfLink\":{\"" +
            "type\":\"string\",\"description\":\"Link to this activity resource.\"},\"title\":{\"type\":" +
            "\"string\",\"description\":\"The title of this collection of activities.\"},\"updated\":" +
            "{\"type\":\"string\",\"description\":\"The time at which this collection of activities " +
            "was last updated. Formatted as an RFC 3339 timestamp.\",\"format\":\"date-time\"}}},\"" +
            "Comment\":{\"id\":\"Comment\",\"type\":\"object\",\"properties\":{\"actor\":{\"type\":\"object\"," +
            "\"description\":\"The person who posted this comment.\",\"properties\":{\"displayName\":" +
            "{\"type\":\"string\",\"description\":\"The name of this actor, suitable for display.\"}," +
            "\"id\":{\"type\":\"string\",\"description\":\"The ID of the actor.\"},\"image\":{\"type\":\"obj" +
            "ect\",\"description\":\"The image representation of this actor.\",\"properties\":{\"url\"" +
            ":{\"type\":\"string\",\"description\":\"The URL of the actor\'s profile photo. To re-siz" +
            "e the image and crop it to a square, append the query string ?sz=x, where x is t" +
            "he dimension in pixels of each side.\"}}},\"url\":{\"type\":\"string\",\"description\":\"A" +
            " link to the person resource for this actor.\"}}},\"id\":{\"type\":\"string\",\"descript" +
            "ion\":\"The ID of this comment.\"},\"inReplyTo\":{\"type\":\"array\",\"description\":\"The a" +
            "ctivity this comment replied to.\",\"items\":{\"type\":\"object\",\"properties\":{\"id\":{\"" +
            "type\":\"string\",\"description\":\"The id of the activity.\"},\"url\":{\"type\":\"string\",\"" +
            "description\":\"The url of the activity.\"}}}},\"kind\":{\"type\":\"string\",\"description" +
            "\":\"Identifies this resource as a comment. Value: \\\"plus#comment\\\".\",\"default\":\"p" +
            "lus#comment\"},\"object\":{\"type\":\"object\",\"description\":\"The object of this commen" +
            "t.\",\"properties\":{\"content\":{\"type\":\"string\",\"description\":\"The content of this " +
            "comment.\"},\"objectType\":{\"type\":\"string\",\"description\":\"The object type of this " +
            "comment. Possible values are:  \\n- \\\"comment\\\" - A comment in reply to an activi" +
            "ty.\",\"default\":\"comment\"}}},\"published\":{\"type\":\"string\",\"description\":\"The time" +
            " at which this comment was initially published. Formatted as an RFC 3339 timesta" +
            "mp.\",\"format\":\"date-time\"},\"selfLink\":{\"type\":\"string\",\"description\":\"Link to th" +
            "is comment resource.\"},\"updated\":{\"type\":\"string\",\"description\":\"The time at whi" +
            "ch this comment was last updated. Formatted as an RFC 3339 timestamp.\",\"format\":" +
            "\"date-time\"},\"verb\":{\"type\":\"string\",\"description\":\"This comment\'s verb, indicat" +
            "ing what action was performed. Possible values are:  \\n- \\\"post\\\" - Publish cont" +
            "ent to the stream.\",\"default\":\"post\"}}},\"CommentFeed\":{\"id\":\"CommentFeed\",\"type\"" +
            ":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"description\":\"The ID of this coll" +
            "ection of comments.\"},\"items\":{\"type\":\"array\",\"items\":{\"$ref\":\"Comment\"}},\"kind\"" +
            ":{\"type\":\"string\",\"description\":\"Identifies this resource as a collection of com" +
            "ments. Value: \\\"plus#commentFeed\\\".\",\"default\":\"plus#commentFeed\"},\"nextLink\":{\"" +
            "type\":\"string\",\"description\":\"Link to the next page of activities.\"},\"nextPageTo" +
            "ken\":{\"type\":\"string\",\"description\":\"The continuation token, used to page throug" +
            "h large result sets. Provide this value in a subsequent request to return the ne" +
            "xt page of results.\"},\"title\":{\"type\":\"string\",\"description\":\"The title of this " +
            "collection of comments.\"},\"updated\":{\"type\":\"string\",\"description\":\"The time at " +
            "which this collection of comments was last updated. Formatted as an RFC 3339 tim" +
            "estamp.\",\"format\":\"date-time\"}}},\"PeopleFeed\":{\"id\":\"PeopleFeed\",\"type\":\"object\"" +
            ",\"properties\":{\"items\":{\"type\":\"array\",\"description\":\"The people in this page of" +
            " results. Each item will include the id, displayName, image, and url for the per" +
            "son. To retrieve additional profile data, see the people.get method.\",\"items\":{\"" +
            "$ref\":\"Person\"}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies this resource" +
            " as a collection of people. Value: \\\"plus#peopleFeed\\\".\",\"default\":\"plus#peopleF" +
            "eed\"},\"nextPageToken\":{\"type\":\"string\",\"description\":\"The continuation token, us" +
            "ed to page through large result sets. Provide this value in a subsequent request" +
            " to return the next page of results.\"},\"selfLink\":{\"type\":\"string\",\"description\"" +
            ":\"Link to this resource.\"},\"title\":{\"type\":\"string\",\"description\":\"The title of " +
            "this collection of people.\"}}},\"Person\":{\"id\":\"Person\",\"type\":\"object\",\"properti" +
            "es\":{\"aboutMe\":{\"type\":\"string\",\"description\":\"A short biography for this person" +
            ".\"},\"birthday\":{\"type\":\"string\",\"description\":\"The person\'s date of birth, repre" +
            "sented as YYYY-MM-DD.\"},\"currentLocation\":{\"type\":\"string\",\"description\":\"The cu" +
            "rrent location for this person.\"},\"displayName\":{\"type\":\"string\",\"description\":\"" +
            "The name of this person, suitable for display.\"},\"emails\":{\"type\":\"array\",\"descr" +
            "iption\":\"A list of email addresses for this person.\",\"items\":{\"type\":\"object\",\"p" +
            "roperties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", indicates th" +
            "is email address is the person\'s primary one.\"},\"type\":{\"type\":\"string\",\"descrip" +
            "tion\":\"The type of address. Possible values are:  \\n- \\\"home\\\" - Home email addr" +
            "ess. \\n- \\\"work\\\" - Work email address. \\n- \\\"other\\\" - Other.\"},\"value\":{\"type\"" +
            ":\"string\",\"description\":\"The email address.\"}}}},\"gender\":{\"type\":\"string\",\"desc" +
            "ription\":\"The person\'s gender. Possible values are:  \\n- \\\"male\\\" - Male gender." +
            " \\n- \\\"female\\\" - Female gender. \\n- \\\"other\\\" - Other.\"},\"hasApp\":{\"type\":\"bool" +
            "ean\",\"description\":\"If \\\"true\\\", indicates that the person has installed the app" +
            " that is making the request and has chosen to expose this install state to the c" +
            "aller. A value of \\\"false\\\" indicates that the install state cannot be determine" +
            "d (it is either not installed or the person has chosen to keep this information " +
            "private).\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of this person.\"},\"image" +
            "\":{\"type\":\"object\",\"description\":\"The representation of the person\'s profile pho" +
            "to.\",\"properties\":{\"url\":{\"type\":\"string\",\"description\":\"The URL of the person\'s" +
            " profile photo. To re-size the image and crop it to a square, append the query s" +
            "tring ?sz=x, where x is the dimension in pixels of each side.\"}}},\"kind\":{\"type\"" +
            ":\"string\",\"description\":\"Identifies this resource as a person. Value: \\\"plus#per" +
            "son\\\".\",\"default\":\"plus#person\"},\"languagesSpoken\":{\"type\":\"array\",\"description\"" +
            ":\"The languages spoken by this person.\",\"items\":{\"type\":\"string\"}},\"name\":{\"type" +
            "\":\"object\",\"description\":\"An object representation of the individual components " +
            "of a person\'s name.\",\"properties\":{\"familyName\":{\"type\":\"string\",\"description\":\"" +
            "The family name (last name) of this person.\"},\"formatted\":{\"type\":\"string\",\"desc" +
            "ription\":\"The full name of this person, including middle names, suffixes, etc.\"}" +
            ",\"givenName\":{\"type\":\"string\",\"description\":\"The given name (first name) of this" +
            " person.\"},\"honorificPrefix\":{\"type\":\"string\",\"description\":\"The honorific prefi" +
            "xes (such as \\\"Dr.\\\" or \\\"Mrs.\\\") for this person.\"},\"honorificSuffix\":{\"type\":\"" +
            "string\",\"description\":\"The honorific suffixes (such as \\\"Jr.\\\") for this person." +
            "\"},\"middleName\":{\"type\":\"string\",\"description\":\"The middle name of this person.\"" +
            "}}},\"nickname\":{\"type\":\"string\",\"description\":\"The nickname of this person.\"},\"o" +
            "rganizations\":{\"type\":\"array\",\"description\":\"A list of current or past organizat" +
            "ions with which this person is associated.\",\"items\":{\"type\":\"object\",\"properties" +
            "\":{\"department\":{\"type\":\"string\",\"description\":\"The department within the organi" +
            "zation.\"},\"description\":{\"type\":\"string\",\"description\":\"A short description of t" +
            "he person\'s role in this organization.\"},\"endDate\":{\"type\":\"string\",\"description" +
            "\":\"The date the person left this organization.\"},\"location\":{\"type\":\"string\",\"de" +
            "scription\":\"The location of this organization.\"},\"name\":{\"type\":\"string\",\"descri" +
            "ption\":\"The name of the organization.\"},\"primary\":{\"type\":\"boolean\",\"description" +
            "\":\"If \\\"true\\\", indicates this organization is the person\'s primary one (typical" +
            "ly interpreted as current one).\"},\"startDate\":{\"type\":\"string\",\"description\":\"Th" +
            "e date the person joined this organization.\"},\"title\":{\"type\":\"string\",\"descript" +
            "ion\":\"The person\'s job title or role within the organization.\"},\"type\":{\"type\":\"" +
            "string\",\"description\":\"The type of organization. Possible values are:  \\n- \\\"wor" +
            "k\\\" - Work. \\n- \\\"school\\\" - School.\"}}}},\"placesLived\":{\"type\":\"array\",\"descrip" +
            "tion\":\"A list of places where this person has lived.\",\"items\":{\"type\":\"object\",\"" +
            "properties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", this place " +
            "of residence is this person\'s primary residence.\"},\"value\":{\"type\":\"string\",\"des" +
            "cription\":\"A place where this person has lived. For example: \\\"Seattle, WA\\\", \\\"" +
            "Near Toronto\\\".\"}}}},\"relationshipStatus\":{\"type\":\"string\",\"description\":\"The pe" +
            "rson\'s relationship status. Possible values are:  \\n- \\\"single\\\" - Person is sin" +
            "gle. \\n- \\\"in_a_relationship\\\" - Person is in a relationship. \\n- \\\"engaged\\\" - " +
            "Person is engaged. \\n- \\\"married\\\" - Person is married. \\n- \\\"its_complicated\\\" " +
            "- The relationship is complicated. \\n- \\\"open_relationship\\\" - Person is in an o" +
            "pen relationship. \\n- \\\"widowed\\\" - Person is widowed. \\n- \\\"in_domestic_partner" +
            "ship\\\" - Person is in a domestic partnership. \\n- \\\"in_civil_union\\\" - Person is" +
            " in a civil union.\"},\"tagline\":{\"type\":\"string\",\"description\":\"The brief descrip" +
            "tion (tagline) of this person.\"},\"url\":{\"type\":\"string\",\"description\":\"The URL o" +
            "f this person\'s profile.\"},\"urls\":{\"type\":\"array\",\"description\":\"A list of URLs " +
            "for this person.\",\"items\":{\"type\":\"object\",\"properties\":{\"primary\":{\"type\":\"bool" +
            "ean\",\"description\":\"If \\\"true\\\", this URL is the person\'s primary URL.\"},\"type\":" +
            "{\"type\":\"string\",\"description\":\"The type of URL. Possible values are:  \\n- \\\"hom" +
            "e\\\" - URL for home. \\n- \\\"work\\\" - URL for work. \\n- \\\"blog\\\" - URL for blog. \\n" +
            "- \\\"profile\\\" - URL for profile. \\n- \\\"other\\\" - Other.\"},\"value\":{\"type\":\"strin" +
            "g\",\"description\":\"The URL value.\"}}}}}},\"PlusAclentryResource\":{\"id\":\"PlusAclent" +
            "ryResource\",\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"description\":\"T" +
            "he ID of the entry. For entries of type \\\"person\\\" or \\\"circle\\\", this is the ID" +
            " of the resource. For other types, this property is not set.\"},\"type\":{\"type\":\"s" +
            "tring\",\"description\":\"The type of entry describing to whom access is granted. Po" +
            "ssible values are:  \\n- \\\"person\\\" - Access to an individual. \\n- \\\"circle\\\" - A" +
            "ccess to members of a circle. \\n- \\\"myCircles\\\" - Access to members of all the p" +
            "erson\'s circles. \\n- \\\"extendedCircles\\\" - Access to members of everyone in a pe" +
            "rson\'s circles, plus all of the people in their circles. \\n- \\\"public\\\" - Access" +
            " to anyone on the web.\"}}}},\"resources\":{\"activities\":{\"methods\":{\"get\":{\"id\":\"p" +
            "lus.activities.get\",\"path\":\"activities/{activityId}\",\"httpMethod\":\"GET\",\"descrip" +
            "tion\":\"Get an activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The ID of the activity to get.\",\"required\":true,\"location\":\"path\"},\"alt\":{\"t" +
            "ype\":\"string\",\"description\":\"Specifies an alternative representation type.\",\"def" +
            "ault\":\"json\",\"enum\":[\"json\"],\"enumDescriptions\":[\"Use JSON format\"],\"location\":\"" +
            "query\"}},\"parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"Activity\"},\"scopes\"" +
            ":[\"https://www.googleapis.com/auth/plus.me\"]},\"list\":{\"id\":\"plus.activities.list" +
            "\",\"path\":\"people/{userId}/activities/{collection}\",\"httpMethod\":\"GET\",\"descripti" +
            "on\":\"List all of the activities in the specified collection for a particular use" +
            "r.\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alternative" +
            " representation type.\",\"default\":\"json\",\"enum\":[\"json\"],\"enumDescriptions\":[\"Use" +
            " JSON format\"],\"location\":\"query\"},\"collection\":{\"type\":\"string\",\"description\":\"" +
            "The collection of activities to list.\",\"required\":true,\"enum\":[\"public\"],\"enumDe" +
            "scriptions\":[\"All public activities created by the specified user.\"],\"location\":" +
            "\"path\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum number of acti" +
            "vities to include in the response, used for paging. For any response, the actual" +
            " number returned may be less than the specified maxResults.\",\"default\":\"20\",\"for" +
            "mat\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"100\",\"location\":\"query\"},\"pageToken\":{\"ty" +
            "pe\":\"string\",\"description\":\"The continuation token, used to page through large r" +
            "esult sets. To get the next page of results, set this parameter to the value of " +
            "\\\"nextPageToken\\\" from the previous response.\",\"location\":\"query\"},\"userId\":{\"ty" +
            "pe\":\"string\",\"description\":\"The ID of the user to get activities for. The specia" +
            "l value \\\"me\\\" can be used to indicate the authenticated user.\",\"required\":true," +
            "\"pattern\":\"me|[0-9]+\",\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"collection" +
            "\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"https://www.googleapis.com/auth" +
            "/plus.me\"]},\"search\":{\"id\":\"plus.activities.search\",\"path\":\"activities\",\"httpMet" +
            "hod\":\"GET\",\"description\":\"Search public activities.\",\"parameters\":{\"maxResults\":" +
            ...
            "ion\":\"Full-text search query string.\",\"location\":\"query\"}},\"response\":{\"$ref\":\"A" +
            ...
            "ts.\",\"default\":\"20\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"100\",\"location\":\"" +
            "query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The continuation token, used" +
            " to page through large result sets. To get the next page of results, set this pa" +
            "rameter to the value of \\\"nextPageToken\\\" from the previous response.\",\"location" +
            "\":\"query\"}},\"parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"CommentFeed\"},\"s" +
            "copes\":[\"https://www.googleapis.com/auth/plus.me\"]}}},\"people\":{\"methods\":{\"get\"" +
            ":{\"id\":\"plus.people.get\",\"path\":\"people/{userId}\",\"httpMethod\":\"GET\",\"descriptio" +
            "n\":\"Get a person\'s profile.\",\"parameters\":{\"userId\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The ID of the person to get the profile for. The special value \\\"me\\\" can be" +
            " used to indicate the authenticated user.\",\"required\":true,\"pattern\":\"me|[0-9]+\"" +
            ",\"location\":\"path\"}},\"parameterOrder\":[\"userId\"],\"response\":{\"$ref\":\"Person\"},\"s" +
            "copes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"listByActivity\":{\"id\":\"plus" +
            ".people.listByActivity\",\"path\":\"activities/{activityId}/people/{collection}\",\"ht" +
            "tpMethod\":\"GET\",\"description\":\"List all of the people in the specified collectio" +
            "n for a particular activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"descr" +
            "iption\":\"The ID of the activity to get the list of people for.\",\"required\":true," +
            "\"location\":\"path\"},\"collection\":{\"type\":\"string\",\"description\":\"The collection o" +
            "f people to list.\",\"required\":true,\"enum\":[\"plusoners\",\"resharers\"],\"enumDescrip" +
            "tions\":[\"List all people who have +1\'d this activity.\",\"List all people who have" +
            " reshared this activity.\"],\"location\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"de" +
            "scription\":\"The maximum number of people to include in the response, used for pa" +
            "ging. For any response, the actual number returned may be less than the specifie" +
            "d maxResults.\",\"default\":\"20\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"100\",\"l" +
            "ocation\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The continuation t" +
            "oken, used to page through large result sets. To get the next page of results, s" +
            "et this parameter to the value of \\\"nextPageToken\\\" from the previous response.\"" +
            ",\"location\":\"query\"}},\"parameterOrder\":[\"activityId\",\"collection\"],\"response\":{\"" +
            "$ref\":\"PeopleFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"searc" +
            "h\":{\"id\":\"plus.people.search\",\"path\":\"people\",\"httpMethod\":\"GET\",\"description\":\"" +
            "Search all public profiles.\",\"parameters\":{\"maxResults\":{\"type\":\"integer\",\"descr" +
            "iption\":\"The maximum number of activities to include in the response, used for p" +
            "aging. For any response, the actual number returned may be less than the specifi" +
            "ed maxResults.\",\"default\":\"10\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"20\",\"l" +
            "ocation\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The continuation t" +
            "oken, used to page through large result sets. To get the next page of results, s" +
            "et this parameter to the value of \\\"nextPageToken\\\" from the previous response. " +
            "This token may be of any length.\",\"location\":\"query\"},\"query\":{\"type\":\"string\",\"" +
            "description\":\"Full-text search query string.\",\"location\":\"query\"}},\"response\":{\"" +
            "$ref\":\"PeopleFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]}}}}}";
