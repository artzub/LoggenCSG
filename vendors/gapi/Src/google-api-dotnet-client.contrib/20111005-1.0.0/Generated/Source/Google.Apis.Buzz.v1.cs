...
namespace Google.Apis.Buzz.v1 {
    ...
    public partial class BuzzService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"buzz:v1\",\"name\":\"buzz\",\"version\":\"v1\",\"" +
            ...
            "\":\"10MB\",\"protocols\":{\"simple\":{\"multipart\":true,\"path\":\"/upload/buzz/v1/activit" +
            "ies/{userId}/@self\"},\"resumable\":{\"multipart\":true,\"path\":\"/resumable/upload/buz" +
            "z/v1/activities/{userId}/@self\"}}}},\"list\":{\"id\":\"chili.activities.list\",\"path\":" +
            "\"activities/{userId}/{scope}\",\"httpMethod\":\"GET\",\"description\":\"List activities\"" +
            ...
            "\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"c\":{\"type\":\"string" +
            ...
            "\",\"location\":\"query\"},\"max-comments\":{\"type\":\"integer\",\"description\":\"Maximum nu" +
            "mber of comments to include.\",\"default\":\"0\",\"format\":\"uint32\",\"location\":\"query\"" +
            "},\"max-liked\":{\"type\":\"integer\",\"description\":\"Maximum number of likes to includ" +
            "e.\",\"default\":\"0\",\"format\":\"uint32\",\"location\":\"query\"},\"max-results\":{\"type\":\"i" +
            "nteger\",\"description\":\"Maximum number of results to include.\",\"default\":\"20\",\"fo" +
            "rmat\":\"uint32\",\"location\":\"query\"},\"scope\":{\"type\":\"string\",\"description\":\"The c" +
            "ollection of activities to list.\",\"required\":true,\"enum\":[\"@comments\",\"@consumpt" +
            "ion\",\"@liked\",\"@public\",\"@self\"],\"enumDescriptions\":[\"Limit to activities commen" +
            "ted on by the user.\",\"Limit to activities to be consumed by the user.\",\"Limit to" +
            " activities liked by the user.\",\"Limit to public activities posted by the user.\"" +
            ",\"Limit to activities posted by the user.\"],\"location\":\"path\"},\"truncateAtom\":{\"" +
            "type\":\"boolean\",\"description\":\"Truncate the value of the atom:content element.\"," +
            "\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user bein" +
            "g referenced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"s" +
            "cope\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"https://www.googleapis.com/" +
            "auth/buzz\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"patch\":{\"id\":\"chil" +
            "i.activities.patch\",\"path\":\"activities/{userId}/{scope}/{postId}\",\"httpMethod\":\"" +
            "PATCH\",\"description\":\"Update an activity. This method supports patch semantics.\"" +
            ",\"parameters\":{\"abuseType\":{\"type\":\"string\",\"location\":\"query\"},\"alt\":{\"type\":\"s" +
            ...
            " format\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code" +
            " to limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"desc" +
            "ription\":\"ID of the activity to update.\",\"required\":true,\"location\":\"path\"},\"sco" +
            "pe\":{\"type\":\"string\",\"description\":\"The collection to which the activity belongs" +
            ".\",\"required\":true,\"enum\":[\"@abuse\",\"@liked\",\"@muted\",\"@self\"],\"enumDescriptions" +
            "\":[\"Activities reported by the user.\",\"Activities liked by the user.\",\"Activitie" +
            "s muted by the user.\",\"Activities posted by the user.\"],\"location\":\"path\"},\"user" +
            "Id\":{\"type\":\"string\",\"description\":\"ID of the user whose post to update.\",\"requi" +
            "red\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\",\"postId\"],\"requ" +
            "est\":{\"$ref\":\"Activity\"},\"response\":{\"$ref\":\"Activity\"},\"scopes\":[\"https://www.g" +
            "oogleapis.com/auth/buzz\"]},\"search\":{\"id\":\"chili.activities.search\",\"path\":\"acti" +
            "vities/search\",\"httpMethod\":\"GET\",\"description\":\"Search for activities\",\"paramet" +
            "ers\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alternative representat" +
            "ion type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom" +
            " XML format\",\"Use JSON format\"],\"location\":\"query\"},\"bbox\":{\"type\":\"string\",\"des" +
            "cription\":\"Bounding box to use in a geographic location query.\",\"location\":\"quer" +
            "y\"},\"c\":{\"type\":\"string\",\"description\":\"A continuation token that allows paginat" +
            "ion.\",\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to " +
            "limit language results.\",\"location\":\"query\"},\"lat\":{\"type\":\"string\",\"description" +
            "\":\"Latitude to use in a geographic location query.\",\"location\":\"query\"},\"lon\":{\"" +
            "type\":\"string\",\"description\":\"Longitude to use in a geographic location query.\"," +
            "\"location\":\"query\"},\"max-results\":{\"type\":\"integer\",\"description\":\"Maximum numbe" +
            "r of results to include.\",\"default\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"" +
            "pid\":{\"type\":\"string\",\"description\":\"ID of a place to use in a geographic locati" +
            "on query.\",\"location\":\"query\"},\"q\":{\"type\":\"string\",\"description\":\"Full-text sea" +
            "rch query string.\",\"location\":\"query\"},\"radius\":{\"type\":\"string\",\"description\":\"" +
            "Radius to use in a geographic location query.\",\"location\":\"query\"},\"truncateAtom" +
            "\":{\"type\":\"boolean\",\"description\":\"Truncate the value of the atom:content elemen" +
            "t.\",\"location\":\"query\"}},\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"https://w" +
            "ww.googleapis.com/auth/buzz\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"" +
            "track\":{\"id\":\"chili.activities.track\",\"path\":\"activities/track\",\"httpMethod\":\"GE" +
            "T\",\"description\":\"Get real-time activity tracking information\",\"parameters\":{\"al" +
            ...
            "at\",\"Use JSON format\"],\"location\":\"query\"},\"bbox\":{\"type\":\"string\",\"description\"" +
            ":\"Bounding box to use in a geographic location query.\",\"location\":\"query\"},\"c\":{" +
            "\"type\":\"string\",\"description\":\"A continuation token that allows pagination.\",\"lo" +
            "cation\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to limit lan" +
            "guage results.\",\"location\":\"query\"},\"lat\":{\"type\":\"string\",\"description\":\"Latitu" +
            "de to use in a geographic location query.\",\"location\":\"query\"},\"lon\":{\"type\":\"st" +
            "ring\",\"description\":\"Longitude to use in a geographic location query.\",\"location" +
            "\":\"query\"},\"max-results\":{\"type\":\"integer\",\"description\":\"Maximum number of resu" +
            "lts to include.\",\"default\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"pid\":{\"ty" +
            "pe\":\"string\",\"description\":\"ID of a place to use in a geographic location query." +
            "\",\"location\":\"query\"},\"q\":{\"type\":\"string\",\"description\":\"Full-text search query" +
            " string.\",\"location\":\"query\"},\"radius\":{\"type\":\"string\",\"description\":\"Radius to" +
            " use in a geographic location query.\",\"location\":\"query\"}},\"response\":{\"$ref\":\"A" +
            "ctivityFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\",\"https://www.goog" +
            "leapis.com/auth/buzz.readonly\"]},\"update\":{\"id\":\"chili.activities.update\",\"path\"" +
            ":\"activities/{userId}/{scope}/{postId}\",\"httpMethod\":\"PUT\",\"description\":\"Update" +
            " an activity\",\"parameters\":{\"abuseType\":{\"type\":\"string\",\"location\":\"query\"},\"al" +
            "t\":{\"type\":\"string\",\"description\":\"Specifies an alternative representation type." +
            "\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML form" +
            "at\",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"" +
            "Language code to limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":\"" +
            "string\",\"description\":\"ID of the activity to update.\",\"required\":true,\"location\"" +
            ":\"path\"},\"scope\":{\"type\":\"string\",\"description\":\"The collection to which the act" +
            "ivity belongs.\",\"required\":true,\"enum\":[\"@abuse\",\"@liked\",\"@muted\",\"@self\"],\"enu" +
            "mDescriptions\":[\"Activities reported by the user.\",\"Activities liked by the user" +
            ".\",\"Activities muted by the user.\",\"Activities posted by the user.\"],\"location\":" +
            "\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user whose post to up" +
            "date.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\",\"p" +
            "ostId\"],\"request\":{\"$ref\":\"Activity\"},\"response\":{\"$ref\":\"Activity\"},\"scopes\":[\"" +
            "https://www.googleapis.com/auth/buzz\"]}}},\"comments\":{\"methods\":{\"delete\":{\"id\":" +
            "\"chili.comments.delete\",\"path\":\"activities/{userId}/@self/{postId}/@comments/{co" +
            "mmentId}\",\"httpMethod\":\"DELETE\",\"description\":\"Delete a comment\",\"parameters\":{\"" +
            ...
            "rmat\",\"Use JSON format\"],\"location\":\"query\"},\"commentId\":{\"type\":\"string\",\"descr" +
            "iption\":\"ID of the comment being referenced.\",\"required\":true,\"location\":\"path\"}" +
            ",\"hl\":{\"type\":\"string\",\"description\":\"Language code to limit language results.\"," +
            "\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"description\":\"ID of the activity " +
            "for which to delete the comment.\",\"required\":true,\"location\":\"path\"},\"userId\":{\"" +
            "type\":\"string\",\"description\":\"ID of the user being referenced.\",\"required\":true," +
            "\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"postId\",\"commentId\"],\"scopes\":[\"" +
            "https://www.googleapis.com/auth/buzz\"]},\"get\":{\"id\":\"chili.comments.get\",\"path\":" +
            "\"activities/{userId}/@self/{postId}/@comments/{commentId}\",\"httpMethod\":\"GET\",\"d" +
            "escription\":\"Get a comment\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"" +
            "Specifies an alternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"" +
            "json\"],\"enumDescriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"" +
            "query\"},\"commentId\":{\"type\":\"string\",\"description\":\"ID of the comment being refe" +
            "renced.\",\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":" +
            "\"Language code to limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":" +
            "\"string\",\"description\":\"ID of the activity for which to get comments.\",\"required" +
            "\":true,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the use" +
            "r being referenced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"user" +
            "Id\",\"postId\",\"commentId\"],\"response\":{\"$ref\":\"Comment\"},\"scopes\":[\"https://www.g" +
            "oogleapis.com/auth/buzz\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"inse" +
            "rt\":{\"id\":\"chili.comments.insert\",\"path\":\"activities/{userId}/@self/{postId}/@co" +
            "mments\",\"httpMethod\":\"POST\",\"description\":\"Create a comment\",\"parameters\":{\"alt\"" +
            ...
            "\",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"La" +
            "nguage code to limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":\"st" +
            "ring\",\"description\":\"ID of the activity on which to comment.\",\"required\":true,\"l" +
            "ocation\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user on whos" +
            "e behalf to comment.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"use" +
            "rId\",\"postId\"],\"request\":{\"$ref\":\"Comment\"},\"response\":{\"$ref\":\"Comment\"},\"scope" +
            "s\":[\"https://www.googleapis.com/auth/buzz\"]},\"list\":{\"id\":\"chili.comments.list\"," +
            "\"path\":\"activities/{userId}/{scope}/{postId}/@comments\",\"httpMethod\":\"GET\",\"desc" +
            "ription\":\"List comments\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Spe" +
            ...
            "tion.\",\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to" +
            " limit language results.\",\"location\":\"query\"},\"max-results\":{\"type\":\"integer\",\"d" +
            "escription\":\"Maximum number of results to include.\",\"default\":\"20\",\"format\":\"uin" +
            "t32\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"description\":\"ID of the acti" +
            "vity for which to get comments.\",\"required\":true,\"location\":\"path\"},\"scope\":{\"ty" +
            "pe\":\"string\",\"description\":\"The collection to which the activity belongs.\",\"requ" +
            "ired\":true,\"enum\":[\"@self\"],\"enumDescriptions\":[\"Activities posted by the user.\"" +
            "],\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user for" +
            " whose post to get comments.\",\"required\":true,\"location\":\"path\"}},\"parameterOrde" +
            "r\":[\"userId\",\"scope\",\"postId\"],\"response\":{\"$ref\":\"CommentFeed\"},\"scopes\":[\"http" +
            "s://www.googleapis.com/auth/buzz\",\"https://www.googleapis.com/auth/buzz.readonly" +
            "\"]},\"patch\":{\"id\":\"chili.comments.patch\",\"path\":\"activities/{userId}/{scope}/{po" +
            "stId}/@comments/{commentId}\",\"httpMethod\":\"PATCH\",\"description\":\"Update a commen" +
            "t. This method supports patch semantics.\",\"parameters\":{\"abuseType\":{\"type\":\"str" +
            "ing\",\"location\":\"query\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alte" +
            "rnative representation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescr" +
            "iptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"commentI" +
            "d\":{\"type\":\"string\",\"description\":\"ID of the comment being referenced.\",\"require" +
            "d\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to" +
            " limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"descrip" +
            "tion\":\"ID of the activity for which to update the comment.\",\"required\":true,\"loc" +
            "ation\":\"path\"},\"scope\":{\"type\":\"string\",\"description\":\"The collection to which t" +
            "he activity belongs.\",\"required\":true,\"enum\":[\"@abuse\",\"@self\"],\"enumDescription" +
            "s\":[\"Comments reported by the user.\",\"Comments posted by the user.\"],\"location\":" +
            ...
            "d\",\"commentId\"],\"request\":{\"$ref\":\"Comment\"},\"response\":{\"$ref\":\"Comment\"},\"scop" +
            "es\":[\"https://www.googleapis.com/auth/buzz\"]},\"update\":{\"id\":\"chili.comments.upd" +
            "ate\",\"path\":\"activities/{userId}/{scope}/{postId}/@comments/{commentId}\",\"httpMe" +
            "thod\":\"PUT\",\"description\":\"Update a comment\",\"parameters\":{\"abuseType\":{\"type\":\"" +
            "string\",\"location\":\"query\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an a" +
            "lternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDe" +
            "scriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"comme" +
            "ntId\":{\"type\":\"string\",\"description\":\"ID of the comment being referenced.\",\"requ" +
            "ired\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code" +
            " to limit language results.\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"desc" +
            "ription\":\"ID of the activity for which to update the comment.\",\"required\":true,\"" +
            "location\":\"path\"},\"scope\":{\"type\":\"string\",\"description\":\"The collection to whic" +
            "h the activity belongs.\",\"required\":true,\"enum\":[\"@abuse\",\"@self\"],\"enumDescript" +
            "ions\":[\"Comments reported by the user.\",\"Comments posted by the user.\"],\"locatio" +
            "n\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user being referen" +
            "ced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\",\"po" +
            "stId\",\"commentId\"],\"request\":{\"$ref\":\"Comment\"},\"response\":{\"$ref\":\"Comment\"},\"s" +
            "copes\":[\"https://www.googleapis.com/auth/buzz\"]}}},\"groups\":{\"methods\":{\"delete\"" +
            ":{\"id\":\"chili.groups.delete\",\"path\":\"people/{userId}/@groups/{groupId}\",\"httpMet" +
            "hod\":\"DELETE\",\"description\":\"Delete a group\",\"parameters\":{\"alt\":{\"type\":\"string" +
            ...
            "at\"],\"location\":\"query\"},\"groupId\":{\"type\":\"string\",\"description\":\"ID of the gro" +
            "up to delete.\",\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"descrip" +
            "tion\":\"Language code to limit language results.\",\"location\":\"query\"},\"userId\":{\"" +
            "type\":\"string\",\"description\":\"ID of the user being referenced.\",\"required\":true," +
            "\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"groupId\"],\"scopes\":[\"https://www" +
            ".googleapis.com/auth/buzz\"]},\"get\":{\"id\":\"chili.groups.get\",\"path\":\"people/{user" +
            "Id}/@groups/{groupId}/@self\",\"httpMethod\":\"GET\",\"description\":\"Get a group\",\"par" +
            ...
            "Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"groupId\":{\"type\":\"strin" +
            "g\",\"description\":\"ID of the group to get.\",\"required\":true,\"location\":\"path\"},\"h" +
            ...
            "eferenced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"grou" +
            "pId\"],\"response\":{\"$ref\":\"Group\"},\"scopes\":[\"https://www.googleapis.com/auth/buz" +
            "z\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"insert\":{\"id\":\"chili.group" +
            "s.insert\",\"path\":\"people/{userId}/@groups\",\"httpMethod\":\"POST\",\"description\":\"Cr" +
            "eate a group\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies an a" +
            "lternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDe" +
            "scriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{" +
            "\"type\":\"string\",\"description\":\"Language code to limit language results.\",\"locati" +
            "on\":\"query\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user being refer" +
            "enced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\"],\"request" +
            "\":{\"$ref\":\"Group\"},\"response\":{\"$ref\":\"Group\"},\"scopes\":[\"https://www.googleapis" +
            ".com/auth/buzz\"]},\"list\":{\"id\":\"chili.groups.list\",\"path\":\"people/{userId}/@grou" +
            "ps\",\"httpMethod\":\"GET\",\"description\":\"Get a user\'s groups\",\"parameters\":{\"alt\":{" +
            ...
            "\"Use JSON format\"],\"location\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A con" +
            "tinuation token that allows pagination.\",\"location\":\"query\"},\"hl\":{\"type\":\"strin" +
            "g\",\"description\":\"Language code to limit language results.\",\"location\":\"query\"}," +
            "\"max-results\":{\"type\":\"integer\",\"description\":\"Maximum number of results to incl" +
            "ude.\",\"default\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"userId\":{\"type\":\"str" +
            "ing\",\"description\":\"ID of the user being referenced.\",\"required\":true,\"location\"" +
            ":\"path\"}},\"parameterOrder\":[\"userId\"],\"response\":{\"$ref\":\"GroupFeed\"},\"scopes\":[" +
            "\"https://www.googleapis.com/auth/buzz\",\"https://www.googleapis.com/auth/buzz.rea" +
            "donly\"]},\"patch\":{\"id\":\"chili.groups.patch\",\"path\":\"people/{userId}/@groups/{gro" +
            "upId}/@self\",\"httpMethod\":\"PATCH\",\"description\":\"Update a group. This method sup" +
            "ports patch semantics.\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Spec" +
            ...
            "y\"},\"groupId\":{\"type\":\"string\",\"description\":\"ID of the group to update.\",\"requi" +
            "red\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code " +
            "to limit language results.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descr" +
            "iption\":\"ID of the user being referenced.\",\"required\":true,\"location\":\"path\"}},\"" +
            "parameterOrder\":[\"userId\",\"groupId\"],\"request\":{\"$ref\":\"Group\"},\"response\":{\"$re" +
            "f\":\"Group\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\"]},\"update\":{\"id\":\"c" +
            "hili.groups.update\",\"path\":\"people/{userId}/@groups/{groupId}/@self\",\"httpMethod" +
            "\":\"PUT\",\"description\":\"Update a group\",\"parameters\":{\"alt\":{\"type\":\"string\",\"des" +
            ...
            "\"people\":{\"methods\":{\"delete\":{\"id\":\"chili.people.delete\",\"path\":\"people/{userId" +
            "}/@groups/{groupId}/{personId}\",\"httpMethod\":\"DELETE\",\"description\":\"Remove a pe" +
            "rson from a group\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies" +
            " an alternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"e" +
            "numDescriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"" +
            "groupId\":{\"type\":\"string\",\"description\":\"ID of the group from which to remove th" +
            "e person.\",\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description" +
            "\":\"Language code to limit language results.\",\"location\":\"query\"},\"personId\":{\"ty" +
            "pe\":\"string\",\"description\":\"ID of the person to remove from the group.\",\"require" +
            "d\":true,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the ow" +
            "ner of the group.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId" +
            "\",\"groupId\",\"personId\"],\"scopes\":[\"https://www.googleapis.com/auth/buzz\"]},\"get\"" +
            ":{\"id\":\"chili.people.get\",\"path\":\"people/{userId}/@self\",\"httpMethod\":\"GET\",\"des" +
            "cription\":\"Get a user profile\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description" +
            "\":\"Specifies an alternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom" +
            "\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location" +
            "\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to limit language " +
            ...
            "userId\"],\"response\":{\"$ref\":\"Person\"},\"scopes\":[\"https://www.googleapis.com/auth" +
            "/buzz\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"liked\":{\"id\":\"chili.pe" +
            "ople.liked\",\"path\":\"activities/{userId}/{scope}/{postId}/{groupId}\",\"httpMethod\"" +
            ":\"GET\",\"description\":\"Get people who liked an activity\",\"parameters\":{\"alt\":{\"ty" +
            ...
            "ing\",\"required\":true,\"enum\":[\"@liked\"],\"enumDescriptions\":[\"People who liked thi" +
            "s activity.\"],\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Language c" +
            "ode to limit language results.\",\"location\":\"query\"},\"max-results\":{\"type\":\"integ" +
            "er\",\"description\":\"Maximum number of results to include.\",\"default\":\"20\",\"format" +
            "\":\"uint32\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"description\":\"ID of th" +
            "e activity that was liked.\",\"required\":true,\"location\":\"path\"},\"scope\":{\"type\":\"" +
            "string\",\"required\":true,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"descriptio" +
            "n\":\"ID of the user being referenced.\",\"required\":true,\"location\":\"path\"}},\"param" +
            "eterOrder\":[\"userId\",\"scope\",\"postId\",\"groupId\"],\"response\":{\"$ref\":\"PeopleFeed\"" +
            "},\"scopes\":[\"https://www.googleapis.com/auth/buzz\",\"https://www.googleapis.com/a" +
            "uth/buzz.readonly\"]},\"list\":{\"id\":\"chili.people.list\",\"path\":\"people/{userId}/@g" +
            "roups/{groupId}\",\"httpMethod\":\"GET\",\"description\":\"Get people in a group\",\"param" +
            ...
            "ription\":\"A continuation token that allows pagination.\",\"location\":\"query\"},\"gro" +
            "upId\":{\"type\":\"string\",\"description\":\"ID of the group for which to list users.\"," +
            "\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Language" +
            " code to limit language results.\",\"location\":\"query\"},\"max-results\":{\"type\":\"int" +
            "eger\",\"description\":\"Maximum number of results to include.\",\"default\":\"20\",\"form" +
            "at\":\"uint32\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of " +
            "the user being referenced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\"" +
            ":[\"userId\",\"groupId\"],\"response\":{\"$ref\":\"PeopleFeed\"},\"scopes\":[\"https://www.go" +
            "ogleapis.com/auth/buzz\",\"https://www.googleapis.com/auth/buzz.readonly\"]},\"patch" +
            "\":{\"id\":\"chili.people.patch\",\"path\":\"people/{userId}/@groups/{groupId}/{personId" +
            "}\",\"httpMethod\":\"PATCH\",\"description\":\"Add a person to a group. This method supp" +
            "orts patch semantics.\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description\":\"Speci" +
            ...
            "\"},\"groupId\":{\"type\":\"string\",\"description\":\"ID of the group to which to add the" +
            " person.\",\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\"" +
            ":\"Language code to limit language results.\",\"location\":\"query\"},\"personId\":{\"typ" +
            "e\":\"string\",\"description\":\"ID of the person to add to the group.\",\"required\":tru" +
            "e,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the owner of" +
            " the group.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"gro" +
            "upId\",\"personId\"],\"request\":{\"$ref\":\"Person\"},\"response\":{\"$ref\":\"Person\"},\"scop" +
            "es\":[\"https://www.googleapis.com/auth/buzz\"]},\"reshared\":{\"id\":\"chili.people.res" +
            "hared\",\"path\":\"activities/{userId}/{scope}/{postId}/{groupId}\",\"httpMethod\":\"GET" +
            "\",\"description\":\"Get people who reshared an activity\",\"parameters\":{\"alt\":{\"type" +
            ...
            "JSON format\"],\"location\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A continua" +
            "tion token that allows pagination.\",\"location\":\"query\"},\"groupId\":{\"type\":\"strin" +
            "g\",\"required\":true,\"enum\":[\"@reshared\"],\"enumDescriptions\":[\"People who reshared" +
            " this activity.\"],\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"description\":\"Langua" +
            "ge code to limit language results.\",\"location\":\"query\"},\"max-results\":{\"type\":\"i" +
            "nteger\",\"description\":\"Maximum number of results to include.\",\"default\":\"20\",\"fo" +
            "rmat\":\"uint32\",\"location\":\"query\"},\"postId\":{\"type\":\"string\",\"description\":\"ID o" +
            "f the activity that was reshared.\",\"required\":true,\"location\":\"path\"},\"scope\":{\"" +
            "type\":\"string\",\"required\":true,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"des" +
            "cription\":\"ID of the user being referenced.\",\"required\":true,\"location\":\"path\"}}" +
            ",\"parameterOrder\":[\"userId\",\"scope\",\"postId\",\"groupId\"],\"response\":{\"$ref\":\"Peop" +
            "leFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\",\"https://www.googleapi" +
            "s.com/auth/buzz.readonly\"]},\"search\":{\"id\":\"chili.people.search\",\"path\":\"people/" +
            "search\",\"httpMethod\":\"GET\",\"description\":\"Search for people\",\"parameters\":{\"alt\"" +
            ":{\"type\":\"string\",\"description\":\"Specifies an alternative representation type.\"," +
            "\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format" +
            "\",\"Use JSON format\"],\"location\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A c" +
            "ontinuation token that allows pagination.\",\"location\":\"query\"},\"hl\":{\"type\":\"str" +
            ...
            "clude.\",\"default\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"q\":{\"type\":\"string" +
            "\",\"description\":\"Full-text search query string.\",\"location\":\"query\"}},\"response\"" +
            ":{\"$ref\":\"PeopleFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\",\"https:/" +
            "/www.googleapis.com/auth/buzz.readonly\"]},\"update\":{\"id\":\"chili.people.update\",\"" +
            "path\":\"people/{userId}/@groups/{groupId}/{personId}\",\"httpMethod\":\"PUT\",\"descrip" +
            "tion\":\"Add a person to a group\",\"parameters\":{\"alt\":{\"type\":\"string\",\"descriptio" +
            ...
            "n\":\"query\"},\"groupId\":{\"type\":\"string\",\"description\":\"ID of the group to which t" +
            "o add the person.\",\"required\":true,\"location\":\"path\"},\"hl\":{\"type\":\"string\",\"des" +
            "cription\":\"Language code to limit language results.\",\"location\":\"query\"},\"person" +
            "Id\":{\"type\":\"string\",\"description\":\"ID of the person to add to the group.\",\"requ" +
            "ired\":true,\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the" +
            " owner of the group.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"use" +
            "rId\",\"groupId\",\"personId\"],\"request\":{\"$ref\":\"Person\"},\"response\":{\"$ref\":\"Perso" +
            "n\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\"]}}},\"photoAlbums\":{\"methods" +
            "\":{\"delete\":{\"id\":\"chili.photoAlbums.delete\",\"path\":\"photos/{userId}/@self/{albu" +
            "mId}\",\"httpMethod\":\"DELETE\",\"description\":\"Delete a photo album\",\"parameters\":{\"" +
            "albumId\":{\"type\":\"string\",\"description\":\"ID of the album to delete.\",\"required\":" +
            "true,\"location\":\"path\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alter" +
            ...
            "d.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"albumId\"],\"s" +
            "copes\":[\"https://www.googleapis.com/auth/picasa\"]},\"get\":{\"id\":\"chili.photoAlbum" +
            "s.get\",\"path\":\"photos/{userId}/@self/{albumId}\",\"httpMethod\":\"GET\",\"description\"" +
            ":\"Get a photo album\",\"parameters\":{\"albumId\":{\"type\":\"string\",\"description\":\"ID " +
            "of the album to get.\",\"required\":true,\"location\":\"path\"},\"alt\":{\"type\":\"string\"," +
            "\"description\":\"Specifies an alternative representation type.\",\"default\":\"atom\",\"" +
            ...
            "terOrder\":[\"userId\",\"albumId\"],\"response\":{\"$ref\":\"Album\"},\"scopes\":[\"https://ww" +
            "w.googleapis.com/auth/picasa\"]},\"insert\":{\"id\":\"chili.photoAlbums.insert\",\"path\"" +
            ":\"photos/{userId}/@self\",\"httpMethod\":\"POST\",\"description\":\"Create a photo album" +
            ...
            "[\"Use Atom XML format\",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{\"type\":\"stri" +
            ...
            "uired\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\"],\"request\":{\"$ref\":\"A" +
            "lbum\"},\"response\":{\"$ref\":\"Album\"},\"scopes\":[\"https://www.googleapis.com/auth/pi" +
            "casa\"]},\"list\":{\"id\":\"chili.photoAlbums.list\",\"path\":\"photos/{userId}/{scope}\",\"" +
            "httpMethod\":\"GET\",\"description\":\"List a user\'s photo albums\",\"parameters\":{\"alt\"" +
            ":{\"type\":\"string\",\"description\":\"Specifies an alternative representation type.\"," +
            "\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format" +
            "\",\"Use JSON format\"],\"location\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A c" +
            "ontinuation token that allows pagination.\",\"location\":\"query\"},\"hl\":{\"type\":\"str" +
            "ing\",\"description\":\"Language code to limit language results.\",\"location\":\"query\"" +
            "},\"max-results\":{\"type\":\"integer\",\"description\":\"Maximum number of results to in" +
            "clude.\",\"default\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"scope\":{\"type\":\"st" +
            "ring\",\"description\":\"The collection of albums to list.\",\"required\":true,\"enum\":[" +
            "\"@self\"],\"enumDescriptions\":[\"Albums posted by the user.\"],\"location\":\"path\"},\"u" +
            "serId\":{\"type\":\"string\",\"description\":\"ID of the user being referenced.\",\"requir" +
            "ed\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\"],\"response\":{\"$r" +
            "ef\":\"AlbumsFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/picasa\"]}}},\"photos" +
            "\":{\"methods\":{\"delete\":{\"id\":\"chili.photos.delete\",\"path\":\"photos/{userId}/@self" +
            "/{albumId}/@photos/{photoId}\",\"httpMethod\":\"DELETE\",\"description\":\"Delete a phot" +
            "o\",\"parameters\":{\"albumId\":{\"type\":\"string\",\"description\":\"ID of the album to wh" +
            "ich to photo belongs.\",\"required\":true,\"location\":\"path\"},\"alt\":{\"type\":\"string\"" +
            ",\"description\":\"Specifies an alternative representation type.\",\"default\":\"atom\"," +
            "\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format\",\"Use JSON forma" +
            "t\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to li" +
            "mit language results.\",\"location\":\"query\"},\"photoId\":{\"type\":\"string\",\"descripti" +
            "on\":\"ID of the photo to delete.\",\"required\":true,\"location\":\"path\"},\"userId\":{\"t" +
            "ype\":\"string\",\"description\":\"ID of the user being referenced.\",\"required\":true,\"" +
            "location\":\"path\"}},\"parameterOrder\":[\"userId\",\"albumId\",\"photoId\"],\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/picasa\"]},\"get\":{\"id\":\"chili.photos.get\",\"path\":\"p" +
            "hotos/{userId}/@self/{albumId}/@photos/{photoId}\",\"httpMethod\":\"GET\",\"descriptio" +
            "n\":\"Get photo metadata\",\"parameters\":{\"albumId\":{\"type\":\"string\",\"description\":\"" +
            "ID of the album containing the photo.\",\"required\":true,\"location\":\"path\"},\"alt\":" +
            "{\"type\":\"string\",\"description\":\"Specifies an alternative representation type.\",\"" +
            "default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format\"" +
            ",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Lan" +
            "guage code to limit language results.\",\"location\":\"query\"},\"photoId\":{\"type\":\"st" +
            "ring\",\"description\":\"ID of the photo for which to get metadata.\",\"required\":true" +
            ",\"location\":\"path\"},\"userId\":{\"type\":\"string\",\"description\":\"ID of the user bein" +
            "g referenced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"a" +
            "lbumId\",\"photoId\"],\"response\":{\"$ref\":\"ChiliPhotosResourceJson\"},\"scopes\":[\"http" +
            "s://www.googleapis.com/auth/picasa\"]},\"insert\":{\"id\":\"chili.photos.insert\",\"path" +
            "\":\"photos/{userId}/{albumId}\",\"httpMethod\":\"POST\",\"description\":\"Upload a photo " +
            "to an album\",\"parameters\":{\"albumId\":{\"type\":\"string\",\"description\":\"ID of the a" +
            "lbum to which to upload.\",\"required\":true,\"location\":\"path\"},\"alt\":{\"type\":\"stri" +
            ...
            "rmat\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language code to" +
            " limit language results.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descrip" +
            "tion\":\"ID of the user being referenced.\",\"required\":true,\"location\":\"path\"}},\"pa" +
            "rameterOrder\":[\"userId\",\"albumId\"],\"request\":{\"$ref\":\"AlbumLite\"},\"response\":{\"$" +
            "ref\":\"AlbumLite\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\"],\"mediaUpload" +
            "\":{\"accept\":[\"image/*\"],\"maxSize\":\"30MB\",\"protocols\":{\"simple\":{\"multipart\":true" +
            ",\"path\":\"/upload/buzz/v1/photos/{userId}/{albumId}\"},\"resumable\":{\"multipart\":tr" +
            "ue,\"path\":\"/resumable/upload/buzz/v1/photos/{userId}/{albumId}\"}}}},\"insert2\":{\"" +
            "id\":\"chili.photos.insert2\",\"path\":\"photos/{userId}/@self/{albumId}/@photos\",\"htt" +
            "pMethod\":\"POST\",\"description\":\"Upload a photo to an album\",\"parameters\":{\"albumI" +
            "d\":{\"type\":\"string\",\"description\":\"ID of the album to which to upload.\",\"require" +
            "d\":true,\"location\":\"path\"},\"alt\":{\"type\":\"string\",\"description\":\"Specifies an al" +
            ...
            "nced.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"albumId\"]" +
            ",\"request\":{\"$ref\":\"ChiliPhotosResourceJson\"},\"response\":{\"$ref\":\"ChiliPhotosRes" +
            "ourceJson\"},\"scopes\":[\"https://www.googleapis.com/auth/picasa\"],\"mediaUpload\":{\"" +
            "accept\":[\"image/*\"],\"maxSize\":\"30MB\",\"protocols\":{\"simple\":{\"multipart\":true,\"pa" +
            "th\":\"/upload/buzz/v1/photos/{userId}/@self/{albumId}/@photos\"},\"resumable\":{\"mul" +
            "tipart\":true,\"path\":\"/resumable/upload/buzz/v1/photos/{userId}/@self/{albumId}/@" +
            "photos\"}}}},\"listByAlbum\":{\"id\":\"chili.photos.listByAlbum\",\"path\":\"photos/{userI" +
            "d}/@self/{albumId}/@photos\",\"httpMethod\":\"GET\",\"description\":\"List photos in an " +
            "album\",\"parameters\":{\"albumId\":{\"type\":\"string\",\"description\":\"ID of the album f" +
            "or which to list photos.\",\"required\":true,\"location\":\"path\"},\"alt\":{\"type\":\"stri" +
            "ng\",\"description\":\"Specifies an alternative representation type.\",\"default\":\"ato" +
            "m\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format\",\"Use JSON fo" +
            "rmat\"],\"location\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A continuation to" +
            "ken that allows pagination.\",\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"descript" +
            "ion\":\"Language code to limit language results.\",\"location\":\"query\"},\"max-results" +
            "\":{\"type\":\"integer\",\"description\":\"Maximum number of results to include.\",\"defau" +
            "lt\":\"20\",\"format\":\"uint32\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descri" +
            "ption\":\"ID of the user being referenced.\",\"required\":true,\"location\":\"path\"}},\"p" +
            "arameterOrder\":[\"userId\",\"albumId\"],\"response\":{\"$ref\":\"PhotosFeed\"},\"scopes\":[\"" +
            "https://www.googleapis.com/auth/picasa\"]},\"listByScope\":{\"id\":\"chili.photos.list" +
            "ByScope\",\"path\":\"photos/{userId}/@self/{scope}/@photos\",\"httpMethod\":\"GET\",\"desc" +
            "ription\":\"Get a user\'s photos\",\"parameters\":{\"alt\":{\"type\":\"string\",\"description" +
            "\":\"Specifies an alternative representation type.\",\"default\":\"atom\",\"enum\":[\"atom" +
            "\",\"json\"],\"enumDescriptions\":[\"Use Atom XML format\",\"Use JSON format\"],\"location" +
            "\":\"query\"},\"c\":{\"type\":\"string\",\"description\":\"A continuation token that allows " +
            "pagination.\",\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"description\":\"Language c" +
            "ode to limit language results.\",\"location\":\"query\"},\"max-results\":{\"type\":\"integ" +
            "er\",\"description\":\"Maximum number of results to include.\",\"default\":\"20\",\"format" +
            "\":\"uint32\",\"location\":\"query\"},\"scope\":{\"type\":\"string\",\"description\":\"The colle" +
            "ction of photos to list.\",\"required\":true,\"enum\":[\"@recent\"],\"enumDescriptions\":" +
            "[\"Recent photos uploaded by the user.\"],\"location\":\"path\"},\"userId\":{\"type\":\"str" +
            "ing\",\"description\":\"ID of the user being referenced.\",\"required\":true,\"location\"" +
            ":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\"],\"response\":{\"$ref\":\"PhotosFeed\"},\"" +
            "scopes\":[\"https://www.googleapis.com/auth/picasa\"]}}},\"related\":{\"methods\":{\"lis" +
            "t\":{\"id\":\"chili.related.list\",\"path\":\"activities/{userId}/{scope}/{postId}/@rela" +
            "ted\",\"httpMethod\":\"GET\",\"description\":\"Get related links for an activity\",\"param" +
            "eters\":{\"alt\":{\"type\":\"string\",\"description\":\"Specifies an alternative represent" +
            "ation type.\",\"default\":\"atom\",\"enum\":[\"atom\",\"json\"],\"enumDescriptions\":[\"Use At" +
            "om XML format\",\"Use JSON format\"],\"location\":\"query\"},\"hl\":{\"type\":\"string\",\"des" +
            "cription\":\"Language code to limit language results.\",\"location\":\"query\"},\"postId" +
            "\":{\"type\":\"string\",\"description\":\"ID of the activity to which to get related lin" +
            "ks.\",\"required\":true,\"location\":\"path\"},\"scope\":{\"type\":\"string\",\"description\":\"" +
            "The collection to which the activity belongs.\",\"required\":true,\"enum\":[\"@self\"]," +
            "\"enumDescriptions\":[\"Activities posted by the user.\"],\"location\":\"path\"},\"userId" +
            "\":{\"type\":\"string\",\"description\":\"ID of the user being referenced.\",\"required\":t" +
            "rue,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"scope\",\"postId\"],\"response\":" +
            "{\"$ref\":\"RelatedFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/buzz\",\"https:/" +
