...
namespace Google.Apis.Prediction.v1_3 {
    ...
    public partial class PredictionService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"id\":\"prediction:v1.3\",\"name\":\"prediction\",\"v" +
            ...
            "erties\":{\"input\":{\"type\":\"object\",\"description\":\"Input to the model for a predic" +
            "tion\",\"properties\":{\"csvInstance\":{\"type\":\"array\",\"description\":\"A list of input" +
            " features, these can be strings or doubles.\",\"items\":{\"type\":\"any\"}}}}}},\"Output" +
            ...
            "el\":{\"type\":\"string\",\"description\":\"The most likely class [Categorical models on" +
            "ly].\"},\"outputMulti\":{\"type\":\"array\",\"description\":\"A list of classes with their" +
            " estimated probabilities [Categorical models only].\",\"items\":{\"type\":\"object\",\"p" +
            "roperties\":{\"label\":{\"type\":\"string\",\"description\":\"The class label.\"},\"score\":{" +
            "\"type\":\"number\",\"description\":\"The probability of the class.\",\"format\":\"double\"}" +
            "}}},\"outputValue\":{\"type\":\"number\",\"description\":\"The estimated regression value" +
            " [Regression models only].\",\"format\":\"double\"},\"selfLink\":{\"type\":\"string\",\"desc" +
            "ription\":\"A URL to re-request this resource.\"}}},\"Training\":{\"id\":\"Training\",\"ty" +
            "pe\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"description\":\"The unique name " +
            "for the predictive model.\"},\"kind\":{\"type\":\"string\",\"description\":\"What kind of " +
            "resource this is.\",\"default\":\"prediction#training\"},\"modelInfo\":{\"type\":\"object\"" +
            ",\"description\":\"Model metadata.\",\"properties\":{\"classWeightedAccuracy\":{\"type\":\"" +
            "number\",\"description\":\"Estimated accuracy of model taking utility weights into a" +
            "ccount [Categorical models only].\",\"format\":\"double\"},\"classificationAccuracy\":{" +
            "\"type\":\"number\",\"description\":\"A number between 0.0 and 1.0, where 1.0 is 100% a" +
            "ccurate. This is an estimate, based on the amount and quality of the training da" +
            "ta, of the estimated prediction accuracy. You can use this is a guide to decide " +
            "whether the results are accurate enough for your needs. This estimate will be mo" +
            "re reliable if your real input data is similar to your training data [Categorica" +
            "l models only].\",\"format\":\"double\"},\"confusionMatrix\":{\"type\":\"object\",\"descript" +
            "ion\":\"An output confusion matrix. This shows an estimate for how this model will" +
            " do in predictions. This is first indexed by the true class label. For each true" +
            " class label, this provides a pair {predicted_label, count}, where count is the " +
            "estimated number of times the model will predict the predicted label given the t" +
            "rue label [Categorical models only].\",\"additionalProperties\":{\"type\":\"object\",\"d" +
            "escription\":\"The true class label.\",\"additionalProperties\":{\"type\":\"number\",\"for" +
            "mat\":\"double\"}}},\"confusionMatrixRowTotals\":{\"type\":\"object\",\"description\":\"A li" +
            "st of the confusion matrix row totals\",\"additionalProperties\":{\"type\":\"number\",\"" +
            "format\":\"double\"}},\"meanSquaredError\":{\"type\":\"number\",\"description\":\"An estimat" +
            "ed mean squared error. The can be used to measure the quality of the predicted m" +
            "odel [Regression models only].\",\"format\":\"double\"},\"modelType\":{\"type\":\"string\"," +
            "\"description\":\"Type of predictive model (CLASSIFICATION or REGRESSION)\"},\"number" +
            "Classes\":{\"type\":\"string\",\"description\":\"Number of classes in the trained model " +
            "[Categorical models only].\",\"format\":\"int64\"},\"numberInstances\":{\"type\":\"string\"" +
            ",\"description\":\"Number of valid data instances used in the trained model.\",\"form" +
            "at\":\"int64\"}}},\"selfLink\":{\"type\":\"string\",\"description\":\"A URL to re-request th" +
            "is resource.\"},\"trainingStatus\":{\"type\":\"string\",\"description\":\"The current stat" +
            "us of the training job. This can be one of following: RUNNING; DONE; ERROR; ERRO" +
            "R: TRAINING JOB NOT FOUND\"},\"utility\":{\"type\":\"array\",\"description\":\"A class wei" +
            "ghting function, which allows the importance weights for classes to be specified" +
            " [Categorical models only].\",\"items\":{\"type\":\"object\",\"description\":\"Class label" +
            " (string).\",\"additionalProperties\":{\"type\":\"number\",\"format\":\"double\"}}}}},\"Upda" +
            "te\":{\"id\":\"Update\",\"type\":\"object\",\"properties\":{\"classLabel\":{\"type\":\"string\",\"" +
            "description\":\"The true class label of this instance\"},\"csvInstance\":{\"type\":\"arr" +
            "ay\",\"description\":\"The input features for this instance\",\"items\":{\"type\":\"any\"}}" +
            "}}},\"resources\":{\"hostedmodels\":{\"methods\":{\"predict\":{\"id\":\"prediction.hostedmo" +
            "dels.predict\",\"path\":\"hostedmodels/{hostedModelName}/predict\",\"httpMethod\":\"POST" +
            "\",\"description\":\"Submit input and request an output against a hosted model\",\"par" +
            "ameters\":{\"hostedModelName\":{\"type\":\"string\",\"description\":\"The name of a hosted" +
            " model\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"hostedModelName\"]" +
            ",\"request\":{\"$ref\":\"Input\"},\"response\":{\"$ref\":\"Output\"},\"scopes\":[\"https://www." +
            "googleapis.com/auth/prediction\"]}}},\"training\":{\"methods\":{\"delete\":{\"id\":\"predi" +
            "ction.training.delete\",\"path\":\"training/{data}\",\"httpMethod\":\"DELETE\",\"descripti" +
            "on\":\"Delete a trained model\",\"parameters\":{\"data\":{\"type\":\"string\",\"description\"" +
            ":\"mybucket/mydata resource in Google Storage\",\"required\":true,\"location\":\"path\"}" +
            "},\"parameterOrder\":[\"data\"],\"scopes\":[\"https://www.googleapis.com/auth/predictio" +
            "n\"]},\"get\":{\"id\":\"prediction.training.get\",\"path\":\"training/{data}\",\"httpMethod\"" +
            ":\"GET\",\"description\":\"Check training status of your model\",\"parameters\":{\"data\":" +
            "{\"type\":\"string\",\"description\":\"mybucket/mydata resource in Google Storage\",\"req" +
            "uired\":true,\"location\":\"path\"}},\"parameterOrder\":[\"data\"],\"response\":{\"$ref\":\"Tr" +
            "aining\"},\"scopes\":[\"https://www.googleapis.com/auth/prediction\"]},\"insert\":{\"id\"" +
            ":\"prediction.training.insert\",\"path\":\"training\",\"httpMethod\":\"POST\",\"description" +
            "\":\"Begin training your model\",\"request\":{\"$ref\":\"Training\"},\"response\":{\"$ref\":\"" +
            "Training\"},\"scopes\":[\"https://www.googleapis.com/auth/prediction\"]},\"predict\":{\"" +
            "id\":\"prediction.training.predict\",\"path\":\"training/{data}/predict\",\"httpMethod\":" +
            "\"POST\",\"description\":\"Submit data and request a prediction\",\"parameters\":{\"data\"" +
            ":{\"type\":\"string\",\"description\":\"mybucket/mydata resource in Google Storage\",\"re" +
            "quired\":true,\"location\":\"path\"}},\"parameterOrder\":[\"data\"],\"request\":{\"$ref\":\"In" +
            "put\"},\"response\":{\"$ref\":\"Output\"},\"scopes\":[\"https://www.googleapis.com/auth/pr" +
            "ediction\"]},\"update\":{\"id\":\"prediction.training.update\",\"path\":\"training/{data}\"" +
            ",\"httpMethod\":\"PUT\",\"description\":\"Add new data to a trained model\",\"parameters\"" +
            ":{\"data\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[" +
            "\"data\"],\"request\":{\"$ref\":\"Update\"},\"response\":{\"$ref\":\"Training\"},\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/prediction\"]}}}}}";
